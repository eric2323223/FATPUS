...
import resources.testscript.Workflow.StartPoint.SP_Email_DB_EditableHelper;
 ...
 * @author eric
 */
public class SP_Email_DB_Editable extends SP_Email_DB_EditableHelper
{
	/**
	 * Script Name   : <b>SP_Email_DB_Editable</b>
	 * Generated     : <b>Sep 9, 2011 4:21:09 PM</b>
	 * Description   : Functional Test Script
	...
	public void testMain(Object[] args) 
	{
		...
		vpManual("Properies", "key1,decimal,", PropertiesView.getStartPoint(WorkFlow.SP_SERVER_INIT).getKey()).performTest();
