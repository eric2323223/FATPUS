...
import resources.testscript.Workflow.StartPoint.SP_Email_DB_mbo_attr_datetimeHelper;
 ...
 * @author eric
 */
public class SP_Email_DB_mbo_attr_datetime extends SP_Email_DB_mbo_attr_datetimeHelper
{
	/**
	 * Script Name   : <b>SP_Email_DB_mbo_attr_datetime</b>
	 * Generated     : <b>Sep 13, 2011 2:56:04 PM</b>
	 * Description   : Functional Test Script
	...
	public void testMain(Object[] args) 
	{
		...
		PropertiesView.setNewKeyBindMBO("key1,DateTime,T_olc,d");
		vpManual("Properies", "key1,DateTime,T_olc/d", PropertiesView.getKeyAttributesofStartPoint(new StartPoint()).getKey()).performTest();
