...
import resources.testscript.Workflow.StartPoint.SP_Email_DB_mbo_attr_dateHelper;
 ...
 * @author eric
 */
public class SP_Email_DB_mbo_attr_date extends SP_Email_DB_mbo_attr_dateHelper
{
	/**
	 * Script Name   : <b>SP_Email_DB_mbo_attr_date</b>
	 * Generated     : <b>Sep 13, 2011 2:25:24 PM</b>
	 * Description   : Functional Test Script
	...
	public void testMain(Object[] args) 
	{
		...
		vpManual("Properies", "key1,DateTime,Employee/birth_date", PropertiesView.getKeyAttributesofStartPoint(new StartPoint()).getKey()).performTest();
