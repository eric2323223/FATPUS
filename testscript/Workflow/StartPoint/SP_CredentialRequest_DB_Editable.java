...
import resources.testscript.Workflow.StartPoint.SP_CredentialRequest_DB_EditableHelper;
 ...
 * @author eric
 */
public class SP_CredentialRequest_DB_Editable extends SP_CredentialRequest_DB_EditableHelper
{
	/**
	 * Script Name   : <b>SP_CredentialRequest_DB_Editable</b>
	 * Generated     : <b>Sep 9, 2011 4:31:58 PM</b>
	 * Description   : Functional Test Script
	...
	public void testMain(Object[] args) 
	{
		...
		vpManual("Properies", true, PropertiesView.getStartPoint(WorkFlow.SP_CREDENTIAL_REQUEST).getKey().contains("key1,int")).performTest();
