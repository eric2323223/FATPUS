...
import resources.testscript.Workflow.StartPoint.SP_Email_DB_lstHelper;
 ...
 * @author eric
 */
public class SP_Email_DB_lst extends SP_Email_DB_lstHelper
{
	/**
	 * Script Name   : <b>SP_Email_DB_lst</b>
	 * Generated     : <b>Sep 9, 2011 4:02:03 PM</b>
	 * Description   : Functional Test Script
	...
	public void testMain(Object[] args) 
	{
		...
		vpManual("Properies", "key1,list,", PropertiesView.getStartPoint(WorkFlow.SP_SERVER_INIT).getKey()).performTest();
