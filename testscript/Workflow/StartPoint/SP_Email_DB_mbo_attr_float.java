...
import resources.testscript.Workflow.StartPoint.SP_Email_DB_mbo_attr_floatHelper;
 ...
 * @author eric
 */
public class SP_Email_DB_mbo_attr_float extends SP_Email_DB_mbo_attr_floatHelper
{
	/**
	 * Script Name   : <b>SP_Email_DB_mbo_attr_float</b>
	 * Generated     : <b>Sep 13, 2011 3:14:33 PM</b>
	 * Description   : Functional Test Script
...
//			.type("Sybase_ASA_12.x").name("My Sample Database"), Cfg.create_table_ff_startPoint);
		...
		PropertiesView.setNewKeyBindMBO("key1,string,Wfff,dept_float");
		vpManual("Properies", "key1,double,Wfff/dept_float", PropertiesView.getKeyAttributesofStartPoint(new StartPoint()).getKey()).performTest();
