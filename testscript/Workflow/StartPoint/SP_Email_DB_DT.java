...
import resources.testscript.Workflow.StartPoint.SP_Email_DB_DTHelper;
 ...
 * @author eric
 */
public class SP_Email_DB_DT extends SP_Email_DB_DTHelper
{
	/**
	 * Script Name   : <b>SP_Email_DB_DT</b>
	 * Generated     : <b>Sep 9, 2011 4:01:12 PM</b>
	 * Description   : Functional Test Script
	...
	public void testMain(Object[] args) 
	{
		...
		vpManual("Properies", "key1,DateTime,", PropertiesView.getStartPoint(WorkFlow.SP_SERVER_INIT).getKey()).performTest();
