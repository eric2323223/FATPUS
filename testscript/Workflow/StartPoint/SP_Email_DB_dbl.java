...
import resources.testscript.Workflow.StartPoint.SP_Email_DB_dblHelper;
 ...
 * @author eric
 */
public class SP_Email_DB_dbl extends SP_Email_DB_dblHelper
{
	/**
	 * Script Name   : <b>SP_Email_DB_dbl</b>
	 * Generated     : <b>Sep 9, 2011 3:58:24 PM</b>
	 * Description   : Functional Test Script
	...
	public void testMain(Object[] args) 
	{
		...
		vpManual("Properies", "key1,double,", PropertiesView.getStartPoint(WorkFlow.SP_SERVER_INIT).getKey()).performTest();
