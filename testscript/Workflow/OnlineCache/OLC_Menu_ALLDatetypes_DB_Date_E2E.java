...
import resources.testscript.Workflow.OnlineCache.OLC_Menu_ALLDatetypes_DB_Date_E2EHelper;
 ...
 * @author min zhao
 */
public class OLC_Menu_ALLDatetypes_DB_Date_E2E extends OLC_Menu_ALLDatetypes_DB_Date_E2EHelper
{
	/**
	 * Script Name   : <b>OLC_Menu_ALLDatetypes_DB_Date_E2E</b>
	 * Generated     : <b>Apr 10, 2012 10:48:17 PM</b>
	 * Description   : Functional Test Script
...
//		
		...
		WorkFlowEditor.addWidget("Start", new WFEditBox().label("type_DATE")
		...
		WorkFlowEditor.addMenuItem("Start", new WFScreenMenuItem()
				...
				.parametermapping("type_DATE,key1"));
	...
	private CustomJsTestScript customJsTestScripts() {
		...
		s.screen("Start").setData("key1", "2009-09-09");
