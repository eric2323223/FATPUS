...
import resources.testscript.Workflow.OnlineCache.OLC_Emai_AllDatetypes_DB_Datetime_E2EHelper;
 ...
 * @author min zhao
 */
public class OLC_Emai_AllDatetypes_DB_Datetime_E2E extends OLC_Emai_AllDatetypes_DB_Datetime_E2EHelper
{
	/**
	 * Script Name   : <b>OLC_Emai_AllDatetypes_DB_Datetime</b>
	 * Generated     : <b>Apr 9, 2012 3:50:50 AM</b>
	 * Description   : Functional Test Script
...
//				GlobalConfig.getRFTProjectRoot()+"/testscript/Workflow/Screens/setup/Alldate.sql");
		...
		mbo.setMboDefinition("sql", "SELECT * FROM sampledb.dba.AllData where type_DATETIME=:type_DATETIME");
...
//				.to(Cfg.deviceUser)
//				.body("<typeInt>2010-08-08T20:00:00</typeInt>")
//				.toMatchingRule("dt")
...
//						.field("Body").toString()));
		...
		.data("list_items_count=2|"+
				"id=AllData_type_DATETIME_attribKey,value=2010-08-08T20:00:00"));
	...
	private CallBackMethod sendNotification() {
		return new CallBackMethod().receiver(WorkFlowEditor.class)
			...
			.parameter(new Email().to("dt").body("<typeInt>2010-08-08T20:00:00</typeInt>"));
	}
	...
	private CustomJsTestScript customJsTestScripts() {
		...
		s.screen("AllDataDetail").getData("AllData_type_DATETIME_attribKey");
		return s;
	}
}
