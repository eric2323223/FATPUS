...
import resources.testscript.Workflow.OnlineCache.OLC_Email_AllDatetypes_SAP_E2EHelper;
 ...
 * @author eric
 */
public class OLC_Email_AllDatetypes_SAP_E2E extends OLC_Email_AllDatetypes_SAP_E2EHelper
{
	/**
	 * Script Name   : <b>OLC_Email_AllDatetypes_SAP_E2E</b>
	 * Generated     : <b>Nov 24, 2011 9:41:01 PM</b>
	 * Description   : Functional Test Script
...
//				.subject("material=M-07")
//				.subjectMatchingRule("material="));
		
//	     WorkFlowEditor.dragMbo(Cfg.projectName, "salesorder_list");
//	     WorkFlowEditor.link(WorkFlow.SP_SERVER_INIT,"salesorderlist");
//		 MainMenu.saveAll();
