...
import resources.testscript.Workflow.OnlineCache.OLC_Email_ALLDatetypes_DB_String1_E2EHelper;
 ...
 * @author min zhao
 */
public class OLC_Email_ALLDatetypes_DB_String1_E2E extends OLC_Email_ALLDatetypes_DB_String1_E2EHelper
{
	/**
	 * Script Name   : <b>OLC_Email_ALLDatetypes_DB_String1</b>
	 * Generated     : <b>Apr 9, 2012 2:36:39 AM</b>
	 * Description   : Functional Test Script
...
//				GlobalConfig.getRFTProjectRoot()+"/testscript/Workflow/Screens/setup/Alldate.sql");
		...
		.data("list_items_count=1|"+
				"id=AllData_type_STRING_attribKey,value=!@#$%^&*(),."));
	...
	private CallBackMethod sendNotification() {
		return new CallBackMethod().receiver(WorkFlowEditor.class)
			...
			.parameter(new Email().to("dt").body("<typeInt>!@#$%^&*()</typeInt>"));
	}
