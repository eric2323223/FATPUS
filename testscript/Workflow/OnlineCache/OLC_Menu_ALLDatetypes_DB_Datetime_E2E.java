...
import resources.testscript.Workflow.OnlineCache.OLC_Menu_ALLDatetypes_DB_Datetime_E2EHelper;
 ...
 * @author min zhao
 */
public class OLC_Menu_ALLDatetypes_DB_Datetime_E2E extends OLC_Menu_ALLDatetypes_DB_Datetime_E2EHelper
{
	/**
	 * Script Name   : <b>OLC_Menu_ALLDatetypes_DB_Datetime_E2E</b>
	 * Generated     : <b>Apr 10, 2012 5:01:18 AM</b>
	 * Description   : Functional Test Script
...
//		
		...
		WorkFlowEditor.addMenuItem("Start", new WFScreenMenuItem()
				...
				.parametermapping("type_DATETIME,key1"));
	...
	private CustomJsTestScript customJsTestScripts() {
		...
		s.screen("Start").setData("key1", "2010-08-08T20:00:00");
