...
import resources.testscript.Workflow.OnlineCache.OLC_Email_AllDatetypes_DB_BOOLEAN_E2EHelper;
 ...
 * @author min zhao
 */
public class OLC_Email_AllDatetypes_DB_BOOLEAN_E2E extends OLC_Email_AllDatetypes_DB_BOOLEAN_E2EHelper
{
	/**
	 * Script Name   : <b>OLC_Email_AllDatetypes_DB_BOOLEAN</b>
	 * Generated     : <b>Apr 9, 2012 5:34:05 AM</b>
	 * Description   : Functional Test Script
...
//						.field("Body").toString()));
	...
	private CallBackMethod sendNotification() {
		return new CallBackMethod().receiver(WorkFlowEditor.class)
			...
			.parameter(new Email().to("dt").body("<typeInt>true</typeInt>"));
	}
