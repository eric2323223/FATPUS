...
import resources.testscript.Workflow.OnlineCache.OLC_Menu_ALLDatetypes_DB_Double_E2EHelper;
 ...
 * @author min zhao
 */
public class OLC_Menu_ALLDatetypes_DB_Double_E2E extends OLC_Menu_ALLDatetypes_DB_Double_E2EHelper
{
	/**
	 * Script Name   : <b>OLC_Menu_ALLDatetypes_DB_Double_E2E</b>
	 * Generated     : <b>Apr 10, 2012 4:52:54 AM</b>
	 * Description   : Functional Test Script
...
//				GlobalConfig.getRFTProjectRoot()+"/testscript/Workflow/Screens/setup/Alldate.sql");
		...
		WorkFlowEditor.addMenuItem("Start", new WFScreenMenuItem()
				...
				.parametermapping("type_DOUBLE,key1"));
