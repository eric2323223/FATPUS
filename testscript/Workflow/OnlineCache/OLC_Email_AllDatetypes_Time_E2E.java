...
import resources.testscript.Workflow.OnlineCache.OLC_Email_AllDatetypes_Time_E2EHelper;
 ...
 * @author min zhao
 */
public class OLC_Email_AllDatetypes_Time_E2E extends OLC_Email_AllDatetypes_Time_E2EHelper
{
	/**
	 * Script Name   : <b>OLC_Email_AllDatetypes_Time</b>
	 * Generated     : <b>Apr 9, 2012 4:57:13 AM</b>
	 * Description   : Functional Test Script
...
//		
	...
	private CallBackMethod sendNotification() {
		return new CallBackMethod().receiver(WorkFlowEditor.class)
			...
			.parameter(new Email().to("dt").body("<typeInt>21:00:00</typeInt>"));
	}
