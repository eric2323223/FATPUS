...
import resources.testscript.Workflow.OnlineCache.OLC_Email_AllDatetypes_DB_E2EHelper;
 ...
 * @author eric
 */
public class OLC_Email_AllDatetypes_DB_E2E extends OLC_Email_AllDatetypes_DB_E2EHelper
{
	/**
	 * Script Name   : <b>OLC_Email_AllDatetypes_DB_E2E</b>
	 * Generated     : <b>Nov 23, 2011 1:44:06 AM</b>
	 * Description   : Functional Test Script
...
//				.serverConnectionMapping("My Sample Database,sampledb"));
	...
	private CallBackMethod sendNotification() {
		return new CallBackMethod().receiver(WorkFlowEditor.class)
			...
			.parameter(new Email().to("dt").body("<typeInt>Q/A</typeInt>"));
	}
