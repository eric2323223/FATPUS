...
import resources.testscript.Workflow.OnlineCache.OLC_Menu_ALLDatetypes_DB_String1Helper;
 ...
 * @author min zhao
 */
public class OLC_Menu_ALLDatetypes_DB_String1 extends OLC_Menu_ALLDatetypes_DB_String1Helper
{
	/**
	 * Script Name   : <b>OLC_Menu_ALLDatetypes_DB_String1</b>
	 * Generated     : <b>Apr 10, 2012 2:12:50 AM</b>
	 * Description   : Functional Test Script
...
//				GlobalConfig.getRFTProjectRoot()+"/testscript/Workflow/Screens/setup/Alldate.sql");
		...
		WorkFlowEditor.addMenuItem("Start", new WFScreenMenuItem()
				...
				.parametermapping("type_STRING,key1"));
