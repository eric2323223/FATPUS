...
import resources.testscript.Workflow.OnlineCache.OLC_Email_ALLDatetypes_DB_Double_E2EHelper;
 ...
 * @author min zhao
 */
public class OLC_Email_ALLDatetypes_DB_Double_E2E extends OLC_Email_ALLDatetypes_DB_Double_E2EHelper
{
	/**
	 * Script Name   : <b>OLC_Email_ALLDatetypes_DB_Double</b>
	 * Generated     : <b>Apr 6, 2012 5:40:56 AM</b>
	 * Description   : Functional Test Script
...
//				GlobalConfig.getRFTProjectRoot()+"/testscript/Workflow/Screens/setup/Alldate.sql");
		...
		.data("list_items_count=2|"+
				"id=AllData_type_DOUBLE_attribKey,value=1"));
	...
	private CustomJsTestScript customJsTestScripts() {
		...
		s.screen("AllDataDetail").getData("AllData_type_DOUBLE_attribKey");
		return s;
	}
}
