...
import resources.testscript.Workflow.Customization.Cust_API_Native_removeAllMenuItems_1_E2EHelper;
 ...
 * @author ffan
 */
public class Cust_API_Native_removeAllMenuItems_1_E2E extends Cust_API_Native_removeAllMenuItems_1_E2EHelper
{
	/**
	 * Script Name   : <b>Cust_API_Native_removeAllMenuItems_1_E2E</b>
	 * Generated     : <b>Mar 27, 2012 8:01:54 PM</b>
	 * Description   : Functional Test Script
...
//		GlobalConfig.getRFTProjectRoot()+"/testscript/Workflow/Screens/setup/create_AllDT.sql");
	...
	private CustomJsTestScript customJsTestScript() {
		...
		s.setMethod("customAfterShowScreen", new File(Config.Cust_API_Native_removeAllMenuItems_1));
