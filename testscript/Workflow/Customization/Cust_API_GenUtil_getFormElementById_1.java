...
import resources.testscript.Workflow.Customization.Cust_API_GenUtil_getFormElementById_1Helper;
 ...
 * @author test
 */
public class Cust_API_GenUtil_getFormElementById_1 extends Cust_API_GenUtil_getFormElementById_1Helper
{
	/**
	 * Script Name   : <b>Cust_API_GenUtil_getFormElementById_1</b>
	 * Generated     : <b>Mar 26, 2012 5:19:27 PM</b>
	 * Description   : Functional Test Script
	...
	private CustomJsTestScript customJsTestScript() {
		...
		s.setMethod("customBeforeShowScreen", new File(Config.Cust_API_GenUtil_getFormElementById_1));
		return s;
	}
}
