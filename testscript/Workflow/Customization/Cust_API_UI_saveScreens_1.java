...
import resources.testscript.Workflow.Customization.Cust_API_UI_saveScreens_1Helper;
 ...
 * @author test
 */
public class Cust_API_UI_saveScreens_1 extends Cust_API_UI_saveScreens_1Helper
{
	/**
	 * Script Name   : <b>Cust_API_saveScreens_1</b>
	 * Generated     : <b>Mar 30, 2012 10:36:23 AM</b>
	 * Description   : Functional Test Script
	...
	public void testMain(Object[] args) 
	{
		...
		WorkFlowEditor.addWidget("Screen2", new WFEditBox()
				.label("label2")
				.newKey("key2,string"));
	...
	private CustomJsTestScript customJsTestScript() {
		...
		s.setMethod("customAfterShowScreen", new File(Config.Cust_API_UI_saveScreens_1));
		return s;
	}
}
