...
import resources.testscript.Workflow.Customization.Cust_API_Native_closeWorkflow_1_E2EHelper;
 ...
 * @author ffan
 */
public class Cust_API_Native_closeWorkflow_1_E2E extends Cust_API_Native_closeWorkflow_1_E2EHelper
{
	/**
	 * Script Name   : <b>Cust_API_Native_closeWorkflow_1_E2E</b>
	 * Generated     : <b>Mar 28, 2012 1:44:04 AM</b>
	 * Description   : Functional Test Script
...
//		MainMenu.saveAll();
	...
	private CustomJsTestScript customJsTestScript() {
		...
		s.setMethod("customAfterShowScreen", new File(Config.Cust_API_Native_closeWorkflow_1));
		return s;
	}
}
