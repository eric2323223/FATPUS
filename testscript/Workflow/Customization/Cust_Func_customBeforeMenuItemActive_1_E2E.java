...
import resources.testscript.Workflow.Customization.Cust_Func_customBeforeMenuItemActive_1_E2EHelper;
 ...
 * @author ffan
 */
public class Cust_Func_customBeforeMenuItemActive_1_E2E extends Cust_Func_customBeforeMenuItemActive_1_E2EHelper
{
	/**
	 * Script Name   : <b>Cust_Func_customBeforeMenuItemActive_1_E2E</b>
	 * Generated     : <b>Mar 22, 2012 10:31:44 PM</b>
	 * Description   : Functional Test Script
...
//		1.used to BB6: passed
		WFCustomizer.verifyResult(new WFClientResult().data("getCurrentScreent=AllDTdeleteinstance"));
		
	}

	private CustomJsTestScript customJsTestScript() {
		CustomJsTestScript s = new CustomJsTestScript();
		s.setMethod("customBeforeMenuItemClick", new File(Config.Cust_Func_customBeforeMenuItemActive_1));
		s.screen("AllDTDetail").moveTo("AllDTdeleteinstance").throughMenuItem("Open AllDTdeleteinstance");
		s.screen("AllDTdeleteinstance").menuItem("Delete");
