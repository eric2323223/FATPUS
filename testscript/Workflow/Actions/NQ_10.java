...
import resources.testscript.Workflow.Actions.NQ_10Helper;
 ...
 * @author flvVm
 */
public class NQ_10 extends NQ_10Helper
{
	/**
	 * Script Name   : <b>NQ_10</b>
	 * Generated     : <b>Oct 10, 2011 6:14:46 PM</b>
	 * Description   : Functional Test Script
	...
	public void testMain(Object[] args) 
	{
		...
		int i = 0;
		String type = TableHelper.getCellValue(table, i++, "Key Name");
		vpManual("Keys", true, type.equals("ErrorLogs")).performTest();
		type = TableHelper.getCellValue(table, i++, "Key Name");
		vpManual("Keys", true, type.equals("Department")).performTest();
		type = TableHelper.getCellValue(table, i++, "Key Name");
		vpManual("Keys", true, type.equals("nameVal")).performTest();
		//
