...
import resources.testscript.Workflow.Actions.NQ_E2E_8_AndroidHelper;
 ...
 * @author flvxp
 */
public class NQ_E2E_8_Android extends NQ_E2E_8_AndroidHelper
{
	/**
	 * Script Name   : <b>NQ_E2E_8_Android</b>
	 * Generated     : <b>Oct 24, 2011 4:05:28 AM</b>
	 * Description   : Functional Test Script
...
//		MBOProperties mbo = new MBOProperties(Cfg.projectName, "Department");
		...
		WFCustomizer.verifyResult(new WFClientResult().data(
				"id=Department_dept_id_attribKey,value=|"+
				"id=Department_dept_name_attribKey,value=|"+ 
				"id=Department_dept_head_id_attribKey,value=|" + 
				"id=Department_dept_id_attribKey,value=|" +
				"id=Department_dept_name_attribKey,value=|"+ 
				"id=Department_dept_head_id_attribKey,value="));
	}
	...
	private CustomJsTestScript customTestScript() {
		...
		s.screen("Start_Screen").setData("deptid", "123");
