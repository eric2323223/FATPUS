...
import resources.testscript.Workflow.Designer_Prop.Prop_FlowDesign_General_2_E2EHelper;
 ...
 * @author ffan
 */
public class Prop_FlowDesign_General_2_E2E extends Prop_FlowDesign_General_2_E2EHelper
{
	/**
	 * Script Name   : <b>Prop_FlowDesign_General_2_E2E</b>
	 * Generated     : <b>Oct 25, 2011 10:34:46 PM</b>
	 * Description   : Functional Test Script
	...
	public void testMain(Object[] args) 
	{
		...
		WFFlowDesigner.setDeleteMessageAsProcessedAfterProcessing("true");
...
//		2.used to BB6: vp= the Email ico is marked...
		TestResult resultBB = Robot.run("tplan.Workflow.iconcommon.BB.EmailIconDeleted.Script");
		vpManual("DeviceTest", true, resultBB.isPass()).performTest();
	}
		
	private CustomJsTestScript customTestScript() {
		CustomJsTestScript s = new CustomJsTestScript();
		s.screen("Departmentcreate").setData("Department_create_dept_id_paramKey", "29");
		s.screen("Departmentcreate").setData("Department_create_dept_name_paramKey", "temp");
