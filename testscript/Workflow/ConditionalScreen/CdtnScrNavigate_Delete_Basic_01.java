...
import resources.testscript.Workflow.ConditionalScreen.CdtnScrNavigate_Delete_Basic_01Helper;
 ...
 * @author ffan
 */
public class CdtnScrNavigate_Delete_Basic_01 extends CdtnScrNavigate_Delete_Basic_01Helper
{
	/**
	 * Script Name   : <b>CdtnScrNavigate_Delete_Basic_01</b>
	 * Generated     : <b>Oct 12, 2011 10:57:13 AM</b>
	 * Description   : Functional Test Script
...
//		new ObjectQueryWizard().create(oq, new WizardRunner()); 
		...
		sleep(0.5);
		PropertiesView.deleteConditionTableOfMenuItem("Start","Submit","mycondition");
