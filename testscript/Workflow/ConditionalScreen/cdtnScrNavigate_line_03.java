...
import resources.testscript.Workflow.ConditionalScreen.cdtnScrNavigate_line_03Helper;
 ...
 * @author ffan
 */
public class cdtnScrNavigate_line_03 extends cdtnScrNavigate_line_03Helper
{
	/**
	 * Script Name   : <b>cdtnScrNavigate_line_03</b>
	 * Generated     : <b>Oct 12, 2011 2:11:09 PM</b>
	 * Description   : Functional Test Script
...
//			.parameter("parameter1,int,true,dept_id")
...
//		new ObjectQueryWizard().create(oq, new WizardRunner()); 
		...
		PropertiesView.deleteConditionTableOfMenuItem("Start","Submit","mycondition2");
		vpManual("ButtonState","null",PropertiesView.getConditionTableOfMenuItem().getKey()).performTest();
		
		vpManual("haslink",false,WorkFlowEditor.hasLinkBetween("Start", "myScreen")).performTest();
	}
}
//passed
