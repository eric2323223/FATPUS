...
import resources.testscript.Workflow.ConditionalScreen.CdtnScrNavigate_Down_01Helper;
 ...
 * @author ffan
 */
public class CdtnScrNavigate_Down_01 extends CdtnScrNavigate_Down_01Helper
{
	/**
	 * Script Name   : <b>CdtnScrNavigate_Down_01</b>
	 * Generated     : <b>Oct 12, 2011 12:17:29 PM</b>
	 * Description   : Functional Test Script
...
//		new ObjectQueryWizard().create(oq, new WizardRunner()); 
		...
		PropertiesView.downConditionTableOfMenuItem("mycondition");
