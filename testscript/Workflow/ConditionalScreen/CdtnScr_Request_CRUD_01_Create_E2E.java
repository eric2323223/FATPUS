...
import resources.testscript.Workflow.ConditionalScreen.CdtnScr_Request_CRUD_01_Create_E2EHelper;
 ...
 * @author ffan
 */
public class CdtnScr_Request_CRUD_01_Create_E2E extends CdtnScr_Request_CRUD_01_Create_E2EHelper
{
	/**
	 * Script Name   : <b>CdtnScr_Request_CRUD_01_Create_E2E</b>
	 * Generated     : <b>Feb 29, 2012 9:11:46 PM</b>
	 * Description   : Functional Test Script
...
//			testscript.Workflow.cfg.Cfg.tplanScript_client_1
		...
		vpManual("db",1,DBUtil.getDB("select * from states where state_id='CH' and state_name='China'")).performTest();
	...
	private CustomJsTestScript script() {
		CustomJsTestScript s = new CustomJsTestScript();
			...
			//create:>>>>>>>>>>>>>>
			s.screen("Statescreate").setData("States_create_state_id_paramKey", "CH");
			...
			s.screen("Statescreate").moveTo("Start").throughMenuItem("Create");
