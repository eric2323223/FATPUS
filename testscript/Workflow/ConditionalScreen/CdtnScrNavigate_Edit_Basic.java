...
import resources.testscript.Workflow.ConditionalScreen.CdtnScrNavigate_Edit_BasicHelper;
 ...
 * @author ffan
 */
public class CdtnScrNavigate_Edit_Basic extends CdtnScrNavigate_Edit_BasicHelper
{
	/**
	 * Script Name   : <b>CdtnScrNavigate_Edit_Basic</b>
	 * Generated     : <b>Oct 12, 2011 10:47:24 AM</b>
	 * Description   : Functional Test Script
...
//		new ObjectQueryWizard().create(oq, new WizardRunner()); 
		...
		PropertiesView.editConditionTableOfMenuItem("mycondition","mycondition2,Start");
		System.out.println("conditionTable: "+PropertiesView.getConditionTableOfMenuItem().getKey());
		vpManual("ButtonState","mycondition2,Start",PropertiesView.getConditionTableOfMenuItem().getKey()).performTest();
	}
}
//passed
