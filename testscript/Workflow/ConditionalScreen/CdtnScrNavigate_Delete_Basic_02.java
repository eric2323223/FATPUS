...
import resources.testscript.Workflow.ConditionalScreen.CdtnScrNavigate_Delete_Basic_02Helper;
 ...
 * @author ffan
 */
public class CdtnScrNavigate_Delete_Basic_02 extends CdtnScrNavigate_Delete_Basic_02Helper
{
	/**
	 * Script Name   : <b>CdtnScrNavigate_Delete_Basic_02</b>
	 * Generated     : <b>Oct 12, 2011 11:15:51 AM</b>
	 * Description   : Functional Test Script
...
//
		...
		System.out.print("editbutton = "+PropertiesView.getButtonState("General", "Delete"));
		vpManual("ButtonState","false",PropertiesView.getButtonState("General", "Delete")).performTest();
	}
}
//passed
