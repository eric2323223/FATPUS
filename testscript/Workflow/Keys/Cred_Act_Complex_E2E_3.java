...
import resources.testscript.Workflow.Keys.Cred_Act_Complex_E2E_3Helper;
 ...
 * @author ffan
 */
public class Cred_Act_Complex_E2E_3 extends Cred_Act_Complex_E2E_3Helper
{
	/**
	 * Script Name   : <b>Cred_Act_Complex_E2E_3_1</b>
	 * Generated     : <b>Oct 28, 2011 4:37:50 AM</b>
	 * Description   : Functional Test Script
...
//		WN.createWorkFlow(new WorkFlow().startParameter(Cfg.projectName).name("myWF_cre_active_1")
		...
		PropertiesView.editModule(new Module().activeKey("1")
											  .credentialCacheKey("ffCredential"));
...
//	WN.createWorkFlow(new WorkFlow().startParameter(Cfg.projectName).name("myWF_cre_active_2")
	...
	WorkFlowEditor.dragMbo(Cfg.projectName, "Testtable");
	PropertiesView.editModule(new Module().activeKey("2")
										  .credentialCacheKey("ffCredential"));
	PropertiesView.setAuthentication("supAdmin","s3pAdmin");
