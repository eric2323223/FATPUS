...
import resources.testscript.Workflow.Keys.ActivationKey_E2E_3_1Helper;
 ...
 * @author ffan
 */
public class ActivationKey_E2E_3_1 extends ActivationKey_E2E_3_1Helper
{
	/**
	 * Script Name   : <b>ActivationKey_E2E_3__1</b>
	 * Generated     : <b>Oct 27, 2011 11:21:52 PM</b>
	 * Description   : Functional Test Script
...
//			"tplan.Workflow.iconcommon.BB.myWF_icon.Script"
		...
		//2.the other WF with same active key:
...
//			"tplan.Workflow.iconcommon.BB.myWF_icon2.Script"
		...
		private CustomJsTestScript customTestScript1() {
		...
		private CustomJsTestScript customTestScript2() {
			CustomJsTestScript s = new CustomJsTestScript();
			s.screen("Start").moveTo("Testtable").throughMenuItem("findAll");
			s.screen("Testtable").getListItemsCount();
			return s;
	...
	//need to go to run ActivationKey_E2E_3_2
}
//passed 20120131