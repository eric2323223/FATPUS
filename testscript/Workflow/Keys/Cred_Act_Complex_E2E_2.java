...
import resources.testscript.Workflow.Keys.Cred_Act_Complex_E2E_2Helper;
 ...
 * @author ffan
 */
public class Cred_Act_Complex_E2E_2 extends Cred_Act_Complex_E2E_2Helper
{
	/**
	 * Script Name   : <b>Cred_Act_Complex_E2E_2_1</b>
	 * Generated     : <b>Oct 28, 2011 4:34:21 AM</b>
	 * Description   : Functional Test Script
...
//		WN.createWorkFlow(new WorkFlow().startParameter(Cfg.projectName).name("myWF_cre_active_1")
		...
		PropertiesView.editModule(new Module().activeKey("myWF_cre_activekey")
											  .credentialCacheKey("1"));
...
//			"tplan.Workflow.iconcommon.BB.myWF_icon.Script"
	...
	//2.the other WF with same active key and different credential key:
