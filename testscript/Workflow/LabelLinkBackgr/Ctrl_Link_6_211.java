...
import resources.testscript.Workflow.LabelLinkBackgr.Ctrl_Link_6_211Helper;
 ...
 * @author xjf
 */
public class Ctrl_Link_6_211 extends Ctrl_Link_6_211Helper
{
	/**
	 * Script Name   : <b>Ctrl_Link_6_211</b>
	 * Generated     : <b>Nov 7, 2011 1:53:29 AM</b>
	 * Description   : Functional Test Script
	...
	public void testMain(Object[] args) 
	{
		...
		WorkFlowEditor.addWidget(Cfg.projectName, "wflink.xbw", "Start Screen", new WFLink().label("linkctrl").logicalType("Phone Number"));
		vpManual("prefixvalue","tel:",DOF.getTextField(DOF.getRoot(), "Prefix:").getProperty("text")).performTest();
