...
import resources.testscript.Workflow.LabelLinkBackgr.Ctrl_Label_8_211Helper;
 ...
 * @author xjf
 */
public class Ctrl_Label_8_211 extends Ctrl_Label_8_211Helper
{
	/**
	 * Script Name   : <b>Ctrl_Label_8_211</b>
	 * Generated     : <b>Nov 4, 2011 2:15:02 AM</b>
	 * Description   : Functional Test Script
...
//					.serverConnectionMapping("My Sample Database,sampledb"));
	...
	//**************end
	   ...
	   DOF.getContextMenu().click(atPath("Delete"));
		MainMenu.saveAll();
		 TestObject[] boxes2 = DOF.getWFLabelFigures(DOF.getRoot());
