...
import resources.testscript.Workflow.LabelLinkBackgr.Ctrl_Link_12_211Helper;
 ...
 * @author xjf
 */
public class Ctrl_Link_12_211 extends Ctrl_Link_12_211Helper
{
	/**
	 * Script Name   : <b>Ctrl_Link_12_211</b>
	 * Generated     : <b>Nov 7, 2011 3:09:05 AM</b>
	 * Description   : Functional Test Script
	...
	public void testMain(Object[] args) 
	{
		...
		WorkFlowEditor.addWidget(Cfg.projectName, "wflink.xbw", "Start Screen", new WFLink().label("linkctrl").newKey("linkkey,string"));
		   ...
		   DOF.getContextMenu().click(atPath("Delete"));
			MainMenu.saveAll();
			 TestObject[] boxes2 = DOF.getWFLinkFigures(DOF.getRoot());
