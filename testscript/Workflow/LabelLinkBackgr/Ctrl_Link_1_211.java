...
import resources.testscript.Workflow.LabelLinkBackgr.Ctrl_Link_1_211Helper;
 ...
 * @author xjf
 */
public class Ctrl_Link_1_211 extends Ctrl_Link_1_211Helper
{
	/**
	 * Script Name   : <b>Ctrl_Link_1_211</b>
	 * Generated     : <b>Nov 4, 2011 2:23:40 AM</b>
	 * Description   : Functional Test Script
...
//					.serverConnectionMapping("My Sample Database,sampledb"));
		...
		MainMenu.saveAll();
		 TestObject[] boxes = DOF.getWFLinkFigures(DOF.getRoot());
		    ...
		    vpManual("ifaddsucc",1,boxes.length).performTest();
	}
}
