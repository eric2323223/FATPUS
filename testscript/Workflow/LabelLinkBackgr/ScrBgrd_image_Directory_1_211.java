...
import resources.testscript.Workflow.LabelLinkBackgr.ScrBgrd_image_Directory_1_211Helper;
 ...
 * @author xjf
 */
public class ScrBgrd_image_Directory_1_211 extends ScrBgrd_image_Directory_1_211Helper
{
	/**
	 * Script Name   : <b>Script1</b>
	 * Generated     : <b>Nov 3, 2011 7:27:10 PM</b>
	 * Description   : Functional Test Script
	...
	public void testMain(Object[] args) 
	{
		...
		//test ScrBgrd_image_Directory_1
...
//		PropertiesView.clickTab("General");
		...
		//need to prepare the image and put it under the project 
		...
		System.out.println(PropertiesView.getStatusMessage());
		//vpManual("wrongimagevalue","Only the images within the project can be used as image source for image control.If the file you wish to use is outside of the project,please add it into the project first.",PropertiesView.getStatusMessage()).performTest();
