...
import resources.testscript.Workflow.LabelLinkBackgr.Ctrl_Link_7_211Helper;
 ...
 * @author xjf
 */
public class Ctrl_Link_7_211 extends Ctrl_Link_7_211Helper
{
	/**
	 * Script Name   : <b>Ctrl_Link_7_211</b>
	 * Generated     : <b>Nov 7, 2011 2:47:11 AM</b>
	 * Description   : Functional Test Script
...
//					.serverConnectionMapping("My Sample Database,sampledb"));
		...
		WorkFlowEditor.addWidget(Cfg.projectName, "wflink.xbw", "Start Screen", new WFLink().label("linkctrl").logicalType("Email Address"));
		vpManual("prefixvalue","mailto:",DOF.getTextField(DOF.getRoot(), "Prefix:").getProperty("text")).performTest();
