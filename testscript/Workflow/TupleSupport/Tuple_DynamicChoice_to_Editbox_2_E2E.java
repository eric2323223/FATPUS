...
import resources.testscript.Workflow.TupleSupport.Tuple_DynamicChoice_to_Editbox_2_E2EHelper;
 ...
 * @author ffan
 */
public class Tuple_DynamicChoice_to_Editbox_2_E2E extends Tuple_DynamicChoice_to_Editbox_2_E2EHelper
{
	/**
	 * Script Name   : <b>Tuple_DynamicChoice_to_Editbox_2_1_E2E</b>
	 * Generated     : <b>Nov 8, 2011 1:28:29 AM</b>
	 * Description   : Functional Test Script
	...
	public void testMain(Object[] args) 
	{
		...
		WorkFlowEditor.addWidget("myscreen3", new WFEditBox().label("C1:")
				.key("c1"));
		WorkFlowEditor.addWidget("myscreen3", new WFEditBox().label("C2:")
				.key("c2"));
...
//			testscript.Workflow.cfg.Cfg.tplanScript_server_2,
		...
		try {
			DBUtil.runSQL((IDBResource) RC.getResource(ASA.class), "delete from Mbo1 where C1=10");
	...
	private CustomJsTestScript customTestScript() {
		...
		s.screen("myscreen1").setData("c1","10");
