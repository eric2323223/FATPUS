...
import resources.testscript.Workflow.TupleSupport.Tuple_DynamicChc_to_DynamicChc_2_E2EHelper;
 ...
 * @author ffan
 */
public class Tuple_DynamicChc_to_DynamicChc_2_E2E extends Tuple_DynamicChc_to_DynamicChc_2_E2EHelper
{
	/**
	 * Script Name   : <b>Tuple_DynamicChc_to_DynamicChc_2_1_E2E</b>
	 * Generated     : <b>Nov 8, 2011 2:07:05 AM</b>
	 * Description   : Functional Test Script
	...
	public void testMain(Object[] args) 
	{
		...
		//set myscreen3:
		WorkFlowEditor.addWidget("myscreen3", new WFEditBox().label("C1:")
				.key("c1"));
		WorkFlowEditor.addWidget("myscreen3", new WFChoice().label("C2:")
				.key("c2")
				.option("Dynamic,key2.key1,key2.key1"));
...
//			testscript.Workflow.cfg.Cfg.tplanScript_server_2, 
	...
	try {
		DBUtil.runSQL((IDBResource) RC.getResource(ASA.class), "delete from Mbo1 where C1=8");
	...
	private CustomJsTestScript customTestScript() {
		...
		s.screen("myscreen1").setData("c1","8");
		s.screen("myscreen1").setData("c2","new");
		...
		s.screen("myscreen3").getData("c1");
		s.screen("myscreen3").getData("c2");
