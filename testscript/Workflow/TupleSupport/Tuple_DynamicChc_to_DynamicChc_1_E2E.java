...
import resources.testscript.Workflow.TupleSupport.Tuple_DynamicChc_to_DynamicChc_1_E2EHelper;
 ...
 * @author ffan
 */
public class Tuple_DynamicChc_to_DynamicChc_1_E2E extends Tuple_DynamicChc_to_DynamicChc_1_E2EHelper
{
	/**
	 * Script Name   : <b>Tuple_DynamicChc_to_DynamicChc_E2E_1</b>
	 * Generated     : <b>Nov 4, 2011 4:03:36 AM</b>
	 * Description   : Functional Test Script
...
//				.to(testscript.Workflow.cfg.Cfg.deviceUser)
		...
		try {
			DBUtil.runSQL((IDBResource) RC.getResource(ASA.class), "delete from Mbo1 where C1=7");
	...
	private CustomJsTestScript customTestScript() {
		...
		s.screen("myscreen1").setData("c1","7");
