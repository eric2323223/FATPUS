...
import resources.testscript.Workflow.TupleSupport.Tuple_StaticChc_to_StaticChc_1_E2EHelper;
 ...
 * @author ffan
 */
public class Tuple_StaticChc_to_StaticChc_1_E2E extends Tuple_StaticChc_to_StaticChc_1_E2EHelper
{
	/**
	 * Script Name   : <b>Tuple_StaticChc_to_StaticChc_1</b>
	 * Generated     : <b>Nov 4, 2011 4:47:18 AM</b>
	 * Description   : Functional Test Script
	...
	public void testMain(Object[] args) 
	{
		...
		GlobalConfig.getRFTProjectRoot()+"/testscript/Workflow/TupleSupport/setup/OneAttribute.sql");
...
//			testscript.Workflow.cfg.Cfg.tplanScript_server_2, 
		...
		try {
			DBUtil.runSQL((IDBResource) RC.getResource(ASA.class), "delete from OneAttribute where id=5");
	...
	private CustomJsTestScript customTestScript() {
		...
		s.screen("myscreen1").setData("id1","5");
