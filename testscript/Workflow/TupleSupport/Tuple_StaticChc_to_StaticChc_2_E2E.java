...
import resources.testscript.Workflow.TupleSupport.Tuple_StaticChc_to_StaticChc_2_E2EHelper;
 ...
 * @author ffan
 */
public class Tuple_StaticChc_to_StaticChc_2_E2E extends Tuple_StaticChc_to_StaticChc_2_E2EHelper
{
	/**
	 * Script Name   : <b>Tuple_StaticChc_to_StaticChc_2_1_E2E</b>
	 * Generated     : <b>Nov 8, 2011 1:01:44 AM</b>
	 * Description   : Functional Test Script
	...
	public void testMain(Object[] args) 
	{
		...
		WorkFlowEditor.addWidget("myscreen1", new WFChoice().label("id1:")
				.newKey("id1,int")
				.option("Static,A1,1:,B1,2:,C1,6")
				);
		
		//set myscreen2:
		
		WorkFlowEditor.addWidget("myscreen2", new WFChoice().label("id2:")
				.key("id1")
				.option("Static,A1,1:,B1,2:,C1,6"));
		...
		//set myscreen3:
		WorkFlowEditor.addWidget("myscreen3", new WFChoice().label("id3:")
				.key("id1")
				.option("Static,A1,1:,B1,2:,C1,6"));
...
//			testscript.Workflow.cfg.Cfg.tplanScript_server_2,
		...
		try {
			DBUtil.runSQL((IDBResource) RC.getResource(ASA.class), "delete from OneAttribute where id=6");
	...
	private CustomJsTestScript customTestScript() {
		...
		s.screen("myscreen1").setData("id1","6");
