...
import resources.testscript.Workflow.TupleSupport.Tuple_DynamicChc_to_DynamicChc_3_E2EHelper;
 ...
 * @author ffan
 */
public class Tuple_DynamicChc_to_DynamicChc_3_E2E extends Tuple_DynamicChc_to_DynamicChc_3_E2EHelper
{
	/**
	 * Script Name   : <b>Tuple_DynamicChc_to_DynamicChc_3</b>
	 * Generated     : <b>Nov 3, 2011 11:36:57 PM</b>
	 * Description   : Functional Test Script
	...
	public void testMain(Object[] args) 
	{
		...
		WorkFlowEditor.addWidget("myscreen2", new WFEditBox().label("id2:")
				.key("id"));
		WorkFlowEditor.addWidget("myscreen2", new WFChoice().label("name2:")
				.key("nam")
				.option("Dynamic,key2.key1,key2.key1"));
		WorkFlowEditor.addWidget("myscreen2", new WFChoice().label("head_id2:")
				.key("head_id")
				.option("Dynamic,key2.key2,key2.key2"));
...
//			testscript.Workflow.cfg.Cfg.tplanScript_server_2,
	...
	try {
		DBUtil.runSQL((IDBResource) RC.getResource(ASA.class), "delete from Department where dept_id=133");
	...
	private CustomJsTestScript customTestScript() {
		...
		s.screen("myscreen1").setData("id","133");
