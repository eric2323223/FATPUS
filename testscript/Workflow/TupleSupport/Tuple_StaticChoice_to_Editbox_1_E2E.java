...
import resources.testscript.Workflow.TupleSupport.Tuple_StaticChoice_to_Editbox_1_E2EHelper;
 ...
 * @author ffan
 */
public class Tuple_StaticChoice_to_Editbox_1_E2E extends Tuple_StaticChoice_to_Editbox_1_E2EHelper
{
	/**
	 * Script Name   : <b>Tuple_StaticChoice_to_Editbox_1_E2E</b>
	 * Generated     : <b>Nov 4, 2011 10:20:35 PM</b>
	 * Description   : Functional Test Script
...
//			testscript.Workflow.cfg.Cfg.tplanScript_server_2,
		...
		try {
			DBUtil.runSQL((IDBResource) RC.getResource(ASA.class), "delete from OneAttribute where id=3");
