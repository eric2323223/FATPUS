...
import resources.testscript.Workflow.ConditionalStartScreen.ConditionalSt_Int_NE_E2EHelper;
 ...
 * @author mzhao
 */
public class ConditionalSt_Int_NE_E2E extends ConditionalSt_Int_NE_E2EHelper
{
	/**
	 * Script Name   : <b>Conditional_Int_NE_E2E</b>
	 * Generated     : <b>Mar 22, 2012 11:19:33 PM</b>
	 * Description   : Functional Test Script
...
//		// create new string type conditional screen 
	...
	//	testscript.Workflow.cfg.Cfg.tplanScript_server_4,
      ...
      //T-plan
       ...
       s.setConditionScreenRule(Cfg.Conditional_Int_NE_E2E);
