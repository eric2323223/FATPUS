...
import resources.testscript.Workflow.ConditionalStartScreen.ConditionalSt_Activation_694234_E2EHelper;
 ...
 * @author mzhao
 */
public class ConditionalSt_Activation_694234_E2E extends ConditionalSt_Activation_694234_E2EHelper
{
	/**
	 * Script Name   : <b>ConditionalSt_Activation_694234_E2E</b>
	 * Generated     : <b>Mar 22, 2012 8:12:35 PM</b>
	 * Description   : Functional Test Script
...
//		testscript.Workflow.cfg.Cfg.tplanScript_server_4,
      ...
      //T-plan
       ...
       s.setConditionScreenRule(Cfg.Conditional_Activation_E2E);
       s.screen("Activate").moveTo("Success").throughMenuItem("Submit Workflow");
