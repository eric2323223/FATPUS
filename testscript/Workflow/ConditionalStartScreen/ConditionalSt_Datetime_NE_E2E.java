...
import resources.testscript.Workflow.ConditionalStartScreen.ConditionalSt_Datetime_NE_E2EHelper;
 ...
 * @author mzhao
 */
public class ConditionalSt_Datetime_NE_E2E extends ConditionalSt_Datetime_NE_E2EHelper
{
	/**
	 * Script Name   : <b>ConditionalSt_Datetime_NE_E2E</b>
	 * Generated     : <b>Mar 23, 2012 1:06:34 AM</b>
	 * Description   : Functional Test Script
...
PropertiesView.addConditionTableOfSP("datetime", "Success");
MainMenu.saveAll();
...
s.setConditionScreenRule(Cfg.Conditional_Datetime_NE_E2E);
