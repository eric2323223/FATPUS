...
import resources.testscript.Workflow.ConditionalStartScreen.ConditionalSt_String_3_E2EHelper;
 ...
 * @author min zhao
 */
public class ConditionalSt_String_3_E2E extends ConditionalSt_String_3_E2EHelper
{
	/**
	 * Script Name   : <b>ConditionalSt_String_3_E2E</b>
	 * Generated     : <b>Mar 13, 2012 11:33:27 PM</b>
	 * Description   : Functional Test Script
...
//		
		...
		PropertiesView.addConditionTableOfSP("number", "Success");
	    MainMenu.saveAll();
	...
	//	testscript.Workflow.cfg.Cfg.tplanScript_server_4,
      ...
      //T-plan
       ...
       s.setConditionScreenRule(Cfg.Conditional_String_1_2_E2E);
