...
import resources.testscript.Workflow.ConditionalStartScreen.ConditionalSt_Int_2_E2EHelper;
 ...
 * @author min zhao
 */
public class ConditionalSt_Int_2_E2E extends ConditionalSt_Int_2_E2EHelper
{
	/**
	 * Script Name   : <b>ConditionalSt_Int_2_E2E</b>
	 * Generated     : <b>Mar 12, 2012 11:27:30 PM</b>
	 * Description   : Functional Test Script
...
//		
	...
	//	testscript.Workflow.cfg.Cfg.tplanScript_server_4, //BB:tplanScript_server_3
		...
		"id=AllMBODataType_type_INT_attribKey,value=2"));
      ...
      //T-plan
       ...
       s.setConditionScreenRule(Cfg.Conditional_String_1_1_E2E);      
       s.screen("AllMBODataTypeDetail").getData("AllMBODataType_type_INT_attribKey");
      return s;
	}
}
