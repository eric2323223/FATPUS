...
import resources.testscript.Workflow.ConditionalStartScreen.ConditionalSt_String_2_E2EHelper;
 ...
 * @author min zhao
 */
public class ConditionalSt_String_2_E2E extends ConditionalSt_String_2_E2EHelper
{
	/**
	 * Script Name   : <b>Conditional_String_2_E2E</b>
	 * Generated     : <b>Mar 12, 2012 7:25:55 PM</b>
	 * Description   : Functional Test Script
...
//		
	...
	//	testscript.Workflow.cfg.Cfg.tplanScript_server_4,
		...
		"id=AllMBODataType_type_STRING_attribKey,value=b"));
      ...
      //T-plan
       ...
       s.screen("AllMBODataTypeDetail").getData("AllMBODataType_type_STRING_attribKey");
      return s;
	}
}
