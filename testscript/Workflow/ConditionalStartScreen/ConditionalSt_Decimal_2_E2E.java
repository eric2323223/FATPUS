...
import resources.testscript.Workflow.ConditionalStartScreen.ConditionalSt_Decimal_2_E2EHelper;
 ...
 * @author min zhao
 */
public class ConditionalSt_Decimal_2_E2E extends ConditionalSt_Decimal_2_E2EHelper
{
	/**
	 * Script Name   : <b>Conditional_Decimal_2_E2E</b>
	 * Generated     : <b>Mar 13, 2012 2:58:20 AM</b>
	 * Description   : Functional Test Script
...
//		
	...
	//	testscript.Workflow.cfg.Cfg.tplanScript_server_4,
		...
		"id=AllMBODataType_type_DECIMAL_attribKey,value=2"));
      ...
      //T-plan
       ...
       s.setConditionScreenRule(Cfg.Conditional_Decimal_1_1_E2E);      
       s.screen("AllMBODataTypeDetail").getData("AllMBODataType_type_DECIMAL_attribKey");
      return s;
	}
}
