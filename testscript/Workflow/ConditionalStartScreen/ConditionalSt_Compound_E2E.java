...
import resources.testscript.Workflow.ConditionalStartScreen.ConditionalSt_Compound_E2EHelper;
 ...
 * @author min zhao
 */
public class ConditionalSt_Compound_E2E extends ConditionalSt_Compound_E2EHelper
{
	/**
	 * Script Name   : <b>ConditionalSt_Compound_E2E</b>
	 * Generated     : <b>Mar 14, 2012 12:29:29 AM</b>
	 * Description   : Functional Test Script
...
//		
		...
		PropertiesView.addConditionTableOfSP("compound", "Success");
	    MainMenu.saveAll();
	...
	//	testscript.Workflow.cfg.Cfg.tplanScript_server_4,
      ...
      //T-plan
       ...
       s.setConditionScreenRule(Cfg.Conditional_Compound_1_1_E2E);
