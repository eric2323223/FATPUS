...
import resources.testscript.Workflow.ConditionalStartScreen.ConditionalSt_Int_LE_E2EHelper;
 ...
 * @author mzhao
 */
public class ConditionalSt_Int_LE_E2E extends ConditionalSt_Int_LE_E2EHelper
{
	/**
	 * Script Name   : <b>Conditional_Int_LE_E2E</b>
	 * Generated     : <b>Mar 22, 2012 11:18:59 PM</b>
	 * Description   : Functional Test Script
...
//		sleep(3);
	...
	//	testscript.Workflow.cfg.Cfg.tplanScript_server_4,
      ...
      //T-plan
       ...
       s.setConditionScreenRule(Cfg.Conditional_Int_LE_E2E);
