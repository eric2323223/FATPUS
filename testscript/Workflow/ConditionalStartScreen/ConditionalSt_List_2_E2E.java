...
import resources.testscript.Workflow.ConditionalStartScreen.ConditionalSt_List_2_E2EHelper;
 ...
 * @author min zhao
 */
public class ConditionalSt_List_2_E2E extends ConditionalSt_List_2_E2EHelper
{
	/**
	 * Script Name   : <b>ConditionalSt_List_2_E2E</b>
	 * Generated     : <b>Mar 14, 2012 1:18:56 AM</b>
	 * Description   : Functional Test Script
...
//		
		...
		PropertiesView.addConditionTableOfSP("ThreeRecord", "Success");
	    MainMenu.saveAll();
	...
	//	testscript.Workflow.cfg.Cfg.tplanScript_server_4,
      ...
      //T-plan
       ...
       s.setConditionScreenRule(Cfg.Conditional_List_2_E2E);
