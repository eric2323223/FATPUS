...
import resources.testscript.Workflow.ConditionalStartScreen.ConditionalSt_Boolean_2_E2EHelper;
 ...
 * @author min zhao
 */
public class ConditionalSt_Boolean_2_E2E extends ConditionalSt_Boolean_2_E2EHelper
{
	/**
	 * Script Name   : <b>Conditional_Boolean_2_E2E</b>
	 * Generated     : <b>Mar 13, 2012 10:44:12 PM</b>
	 * Description   : Functional Test Script
...
//		
		...
		PropertiesView.addConditionTableOfSP("bool", "Success");
		MainMenu.saveAll();
	...
	//	testscript.Workflow.cfg.Cfg.tplanScript_server_4,
		...
		"id=AllMBODataType_type_BOOLEAN_attribKey,value=False"));
      ...
      //T-plan
       ...
       s.setConditionScreenRule(Cfg.Conditional_Boolean_1_1_E2E);      
       s.screen("AllMBODataTypeDetail").getData("AllMBODataType_type_BOOLEAN_attribKey");
      return s;
	}
}
