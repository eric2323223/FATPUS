...
import resources.testscript.Workflow.ConditionalStartScreen.ConditionalSt_Decimal_GE_E2EHelper;
 ...
 * @author mzhao
 */
public class ConditionalSt_Decimal_GE_E2E extends ConditionalSt_Decimal_GE_E2EHelper
{
	/**
	 * Script Name   : <b>ConditionalSt_Decimal_GE_E2E</b>
	 * Generated     : <b>Mar 23, 2012 1:02:49 AM</b>
	 * Description   : Functional Test Script
...
//		testscript.Workflow.cfg.Cfg.tplanScript_server_4,
	...
	//	testscript.Workflow.cfg.Cfg.tplanScript_server_4,
      ...
      //T-plan
       ...
       s.setConditionScreenRule(Cfg.Conditional_Decimal_GE_E2E);
