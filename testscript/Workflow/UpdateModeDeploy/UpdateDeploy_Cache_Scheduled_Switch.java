...
import resources.testscript.Workflow.UpdateModeDeploy.UpdateDeploy_Cache_Scheduled_SwitchHelper;
 ...
 * @author whan
 */
public class UpdateDeploy_Cache_Scheduled_Switch extends UpdateDeploy_Cache_Scheduled_SwitchHelper
{
	/**
	 * Script Name   : <b>UpdateDeploy_Cache_Scheduled_Switch</b>
	 * Generated     : <b>Mar 26, 2012 12:36:11 AM</b>
	 * Description   : Functional Test Script
	...
	public void testMain(Object[] args) 
	{
		...
		WN.setCacheGroup(Cfg.projectName, "Default (Default)", new CacheGroup().type(CachePolicy.SCHEDULED).hour("1").minute("1").second("1"));
		// MBO
		...
		WN.setCacheGroup(Cfg.projectName, "Default (Default)", new CacheGroup().type(CachePolicy.ONDEMAND).hour("2").minute("2").second("2"));
		MainMenu.saveAll();
