...
import resources.testscript.Workflow.UpdateModeDeploy.UpdateDeploy_OperCache_1Helper;
...
import com.sybase.djc.deploy.j2ee13ri.dd.Operation;
 ...
 * @author whan
 */
public class UpdateDeploy_OperCache_1 extends UpdateDeploy_OperCache_1Helper
{
	/**
	 * Script Name   : <b>UpdateDeploy_OperCache_1</b>
	 * Generated     : <b>Mar 27, 2012 12:35:21 AM</b>
	 * Description   : Functional Test Script
	...
	public void testMain(Object[] args) 
	{
		...
		WN.setCacheGroup(Cfg.projectName, "Default (Default)", new CacheGroup().type(CachePolicy.ONDEMAND));
		// MBO
		...
		new MBOProperties(Cfg.projectName,"Department").setOperationCachePolicy(new component.entity.model.Operation().name("create"), "Immediately update the cache",false);
		MainMenu.saveAll();
