...
import resources.testscript.Workflow.UpdateModeDeploy.UpdateModeDeploy_Query_ModifyHelper;
 ...
 * @author whan
 */
public class UpdateModeDeploy_Query_Modify extends UpdateModeDeploy_Query_ModifyHelper
{
	/**
	 * Script Name   : <b>UpdateModeDeploy_Query_Modify</b>
	 * Generated     : <b>Mar 19, 2012 7:07:14 PM</b>
	 * Description   : Functional Test Script
	...
	public void testMain(Object[] args) 
	{
		...
		WN.openDiagramEditor(Cfg.projectName);
		EE.dnd("Database Connections->My Sample Database->sampledb->Tables->department (dba)");
	     ...
	     .name("ObjQuery")
	     .startParameter(WN.mboPath(Cfg.projectName, "Department"))
	     .parameter("head_id,int,true,dept_head_id")
	     .queryDefinition("SELECT x.* FROM Department x WHERE x.dept_head_id = :head_id")
	     .returnType(ObjectQueryWizard.RT_RESULTSET));
