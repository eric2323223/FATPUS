...
import resources.testscript.Workflow.UpdateModeDeploy.UpdateDeploy_OperCache_2Helper;
 ...
 * @author whan
 */
public class UpdateDeploy_OperCache_2 extends UpdateDeploy_OperCache_2Helper
{
	/**
	 * Script Name   : <b>UpdateDeploy_OperCache_2</b>
	 * Generated     : <b>Mar 27, 2012 10:37:54 PM</b>
	 * Description   : Functional Test Script
	...
	new MBOProperties(Cfg.projectName,"Department").setOperationCachePolicy(new component.entity.model.Operation().name("create"), "Invalidate the cache",false);
	MainMenu.saveAll();
