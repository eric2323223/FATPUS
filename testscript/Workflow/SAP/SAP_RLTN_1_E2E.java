...
import resources.testscript.Workflow.SAP.SAP_RLTN_1_E2EHelper;
 ...
 * @author ffan
 */
public class SAP_RLTN_1_E2E extends SAP_RLTN_1_E2EHelper
{
	/**
	 * Script Name   : <b>SAP_RLTN_1_E2E</b>
	 * Generated     : <b>Dec 2, 2011 10:19:54 PM</b>
	 * Description   : Functional Test Script
...
////		EE.createSAPCP(new SAPCP(RC.getResource(SAP.class)).name("sap"), true);
		...
		MBOProperties mboN = new MBOProperties(Cfg.projectName, "customer_list");
		mboN.setAttribute(new MBOAttribute().name("SALESORG").primaryKey(true));
		mboN.setAttribute(new MBOAttribute().name("CUSTOMER").primaryKey(true));
		
		MBOProperties mbo = new MBOProperties(Cfg.projectName, "salesorder_list");
		mbo.setAttribute(new MBOAttribute().name("MATERIAL").primaryKey(true));
