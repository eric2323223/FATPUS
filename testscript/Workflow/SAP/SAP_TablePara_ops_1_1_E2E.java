...
import resources.testscript.Workflow.SAP.SAP_TablePara_ops_1_1_E2EHelper;
 ...
 * @author ffan
 */
public class SAP_TablePara_ops_1_1_E2E extends SAP_TablePara_ops_1_1_E2EHelper
{
	/**
	 * Script Name   : <b>SAP_TablePara_ops_2_E2E</b>
	 * Generated     : <b>Nov 30, 2011 4:35:28 AM</b>
	 * Description   : Functional Test Script
	...
	private CustomJsTestScript customJsTestScript() {
		...
		s.screen("Bankupdate1").setData("Bank_update_CITY_paramKey", "AM");
		s.screen("Bankupdate1").setData("Bank_update_BANKCOUNTRY_paramKey", "AM");
	
		s.screen("Bankupdate1").moveTo("Start Screen").throughMenuItem("Update");
