...
import resources.testscript.Workflow.SAP.SAP_TablePara_ops_1_2_E2EHelper;
 ...
 * @author ffan
 */
public class SAP_TablePara_ops_1_2_E2E extends SAP_TablePara_ops_1_2_E2EHelper
{
	/**
	 * Script Name   : <b>SAP_TablePara_ops_2_2_E2E</b>
	 * Generated     : <b>Feb 23, 2012 2:59:14 AM</b>
	 * Description   : Functional Test Script
...
//		EE.createSAPCP(new SAPCP(RC.getResource(SAP.class)).name("sap"), true);
		...
		WN.addSAPOperation(new SAPOperation().startParameter(WN.mboPath(Cfg.projectName, "Bank"))
				...
				.parameter("BANK_CTRY->BANK_CTRY[CHAR],in")
				.parameter("BANK_KEY->BANK_KEY[CHAR],in")
				.parameter("RETURN,out")
		);
		...
		WorkFlowEditor.link("BankDetail", "Bankcreate");
	...
	private CustomJsTestScript customJsTestScript() {
		...
		s.screen("BankDetail").moveTo("Bankcreate").throughMenuItem("Open Bankcreate");
		
		s.screen("Bankcreate").setData("Bank_create_BANK_NAME_paramKey", "MYSELF");
		s.screen("Bankcreate").setData("Bank_create_CITY_paramKey", "AM");
		s.screen("Bankcreate").setData("Bank_create_BANK_CTRY_paramKey", "AM");
		s.screen("Bankcreate").setData("Bank_create_BANK_KEY_paramKey", "0023");
