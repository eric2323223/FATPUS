...
import resources.testscript.Workflow.SAP.SAP_TablePara_PK_OLC_E2EHelper;
 ...
 * @author ffan
 */
public class SAP_TablePara_PK_OLC_E2E extends SAP_TablePara_PK_OLC_E2EHelper
{
	/**
	 * Script Name   : <b>SAP_TablePara_PK_OLC_E2E</b>
	 * Generated     : <b>Nov 30, 2011 3:30:28 AM</b>
	 * Description   : Functional Test Script
...
//		EE.createSAPCP(new SAPCP(RC.getResource(SAP.class)).name("sap"), true);
		...
		WorkFlowEditor.addMenuItem("Start", new WFScreenMenuItem().name("findbyparameter")
				.type("Online Request")
	...
	private CustomJsTestScript customJsTestScript() {
		...
		s.screen("Start").moveTo("Bank").throughMenuItem("findbyparameter");
