...
import resources.testscript.Workflow.AsyncErrHdl.AsyncErrHdl_SubmitWF_Subject1Helper;
 ...
 * @author flvxp
 */
public class AsyncErrHdl_SubmitWF_Subject1 extends AsyncErrHdl_SubmitWF_Subject1Helper
{
	/**
	 * Script Name   : <b>AsyncErrHdl_SubmitWF_Subject1</b>
	 * Generated     : <b>Mar 21, 2012 1:02:41 AM</b>
	 * Description   : Functional Test Script
	...
	public void testMain(Object[] args) 
	{
		...
		WorkFlowEditor.setMenuItem("Start", new WFScreenMenuItem().name("Menu")
				.subject("SubjectInfo"));
		vpManual("ESField", true, PropertiesView.getMenuItem("Start", "Menu").getSubject().equals("SubjectInfo")).performTest();
		//
