...
import resources.testscript.Workflow.AsyncErrHdl.AsyncErrHdl_SubmitWF_From3Helper;
 ...
 * @author flvxp
 */
public class AsyncErrHdl_SubmitWF_From3 extends AsyncErrHdl_SubmitWF_From3Helper
{
	/**
	 * Script Name   : <b>AsyncErrHdl_SubmitWF_From3</b>
	 * Generated     : <b>Mar 21, 2012 8:19:22 PM</b>
	 * Description   : Functional Test Script
...
//		vpManual("SujectField", false, DOF.getTextField(DOF.getRoot(), "Subject:").isEnabled()).performTest();
		...
		vpManual("SujectField", true, PropertiesView.getMenuItem("Start", "Menu").getFrom().equals("from")).performTest();
	}
}
