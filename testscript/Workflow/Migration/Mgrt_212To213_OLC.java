...
import resources.testscript.Workflow.Migration.Mgrt_212To213_OLCHelper;
 ...
 * @author jiaozhou
 */
public class Mgrt_212To213_OLC extends Mgrt_212To213_OLCHelper
{
	/**
	 * Script Name   : <b>Mgrt_212To213_OLC</b>
	 * Generated     : <b>May 25, 2012 10:47:06 AM</b>
	 * Description   : Functional Test Script
	...
	public void testMain(Object[] args) 
	{
		...
		WFCustomizer.runTest(new WorkFlowPackage()
			.startParameter(WN.filePath(Cfg.projectName4, "onlinequery"))
...
//			"tplan.Workflow.iconcommon.BB.Mgrt_icons.Script"
	...
	private CustomJsTestScript customTestScript() {
		...
		s.screen("Start_Screen").setData("item", "400");
		s.screen("Start_Screen").moveTo("DepartmentOnline").throughMenuItem("invoke");
