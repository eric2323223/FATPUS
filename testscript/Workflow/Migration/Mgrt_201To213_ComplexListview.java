...
import resources.testscript.Workflow.Migration.Mgrt_201To213_ComplexListviewHelper;
 ...
 * @author jiaozhou
 */
public class Mgrt_201To213_ComplexListview extends Mgrt_201To213_ComplexListviewHelper
{
	/**
	 * Script Name   : <b>Mgrt_201To213_ComplexListview</b>
	 * Generated     : <b>May 10, 2012 1:40:22 PM</b>
	 * Description   : Functional Test Script
	...
	public void testMain(Object[] args) 
	{
		...
		WorkFlowEditor.open("pro201", "relationwf");
		WFCustomizer.runTest(new WorkFlowPackage()
		.startParameter(WN.filePath(Cfg.projectName1, "relationwf"))
...
//		"tplan.Workflow.iconcommon.BB.Mgrt_icons_srv.Script",
	...
	private CallBackMethod sendNotification() {
		return new CallBackMethod().receiver(WorkFlowEditor.class)
			...
			.parameter(new Email().to("dt").subject("relation"));
	}
