...
import resources.testscript.Workflow.Migration.Mgrt_211To213_CtrlHelper;
 ...
 * @author jiaozhou
 */
public class Mgrt_211To213_Ctrl extends Mgrt_211To213_CtrlHelper
{
	/**
	 * Script Name   : <b>Mgrt_211To213_Ctrl</b>
	 * Generated     : <b>May 24, 2012 1:59:33 PM</b>
	 * Description   : Functional Test Script
	...
	public void testMain(Object[] args) 
	{
		...
		WorkFlowEditor.open("projectfor211", "controlwf");
		WFCustomizer.runTest(new WorkFlowPackage()
		.startParameter(WN.filePath(Cfg.projectName3, "controlwf"))
...
//		"tplan.Workflow.iconcommon.BB.Mgrt_icons_srv.Script",
	...
	private CallBackMethod sendNotification() {
		return new CallBackMethod().receiver(WorkFlowEditor.class)
			...
			.parameter(new Email().to("dt").subject("alltype211"));
	}
