...
import resources.testscript.Workflow.Migration.Mgrt_212To213_CUD_1Helper;
 ...
 * @author jiaozhou
 */
public class Mgrt_212To213_CUD_1 extends Mgrt_212To213_CUD_1Helper
{
	/**
	 * Script Name   : <b>Mgrt_212To213_CUD_1</b>
	 * Generated     : <b>May 24, 2012 3:13:48 PM</b>
	 * Description   : Functional Test Script
	...
	public void testMain(Object[] args) 
	{
		...
		.startParameter(WN.filePath(Cfg.projectName4, "synccrudwf"))
...
//		"tplan.Workflow.iconcommon.BB.Mgrt_icons.Script"
	...
	private CustomJsTestScript customTestScript() {
		...
		s.screen("Department_create").moveTo("Department_delete_instance").throughMenuItem("Create");
//		s.screen("Department_delete_instance").setData("Department_dept_id_attribKey", "2");
		return s;
	}
}
