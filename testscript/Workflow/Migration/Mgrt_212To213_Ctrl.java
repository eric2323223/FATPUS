...
import resources.testscript.Workflow.Migration.Mgrt_212To213_CtrlHelper;
 ...
 * @author jiaozhou
 */
public class Mgrt_212To213_Ctrl extends Mgrt_212To213_CtrlHelper
{
	/**
	 * Script Name   : <b>Mgrt_212To213_Ctrl</b>
	 * Generated     : <b>May 25, 2012 10:59:22 AM</b>
	 * Description   : Functional Test Script
	...
	public void testMain(Object[] args) 
	{
		...
		WorkFlowEditor.open("pro212", "controlwf");
		WFCustomizer.runTest(new WorkFlowPackage()
		.startParameter(WN.filePath(Cfg.projectName4, "controlwf"))
...
//		"tplan.Workflow.iconcommon.BB.Mgrt_icons_srv.Script",
	...
	private CallBackMethod sendNotification() {
		return new CallBackMethod().receiver(WorkFlowEditor.class)
			...
			.parameter(new Email().to("dt").subject("ctrl212"));
	}
