...
import resources.testscript.Workflow.Migration.Mgrt_201To213_CUD_2Helper;
 ...
 * @author jiaozhou
 */
public class Mgrt_201To213_CUD_2 extends Mgrt_201To213_CUD_2Helper
{
	/**
	 * Script Name   : <b>Mgrt_201To213_CUD_2</b>
	 * Generated     : <b>May 9, 2012 4:14:13 PM</b>
	 * Description   : Functional Test Script
	...
	public void testMain(Object[] args) 
	{
		...
		WorkFlowEditor.open("pro201", "synccrudwf1");
		WFCustomizer.runTest(new WorkFlowPackage()
		.startParameter(WN.filePath(Cfg.projectName1, "synccrudwf1"))
...
//		"tplan.Workflow.iconcommon.BB.Mgrt_icons.Script",
	...
	private CallBackMethod sendNotification() {
		return new CallBackMethod().receiver(WorkFlowEditor.class)
			...
			.parameter(new Email().to("dt").subject("findall201"));
	}
