...
import resources.testscript.Workflow.Migration.Mgrt_211To213_CUD_2Helper;
 ...
 * @author jiaozhou
 */
public class Mgrt_211To213_CUD_2 extends Mgrt_211To213_CUD_2Helper
{
	/**
	 * Script Name   : <b>Mgrt_211To213_CUD_2</b>
	 * Generated     : <b>May 11, 2012 3:33:29 PM</b>
	 * Description   : Functional Test Script
	...
	public void testMain(Object[] args) 
	{
		...
		WorkFlowEditor.open("projectfor211", "synccrudwf1");
		WFCustomizer.runTest(new WorkFlowPackage()
		.startParameter(WN.filePath(Cfg.projectName3, "synccrudwf1"))
...
//		"tplan.Workflow.iconcommon.BB.Mgrt_icons.Script",
	...
	private CallBackMethod sendNotification() {
		return new CallBackMethod().receiver(WorkFlowEditor.class)
			...
			.parameter(new Email().to("dt").subject("findall211"));
	}
