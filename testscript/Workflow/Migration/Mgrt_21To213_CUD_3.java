...
import resources.testscript.Workflow.Migration.Mgrt_21To213_CUD_3Helper;
 ...
 * @author jiaozhou
 */
public class Mgrt_21To213_CUD_3 extends Mgrt_21To213_CUD_3Helper
{
	/**
	 * Script Name   : <b>Mgrt_21To213_CUD_3</b>
	 * Generated     : <b>May 10, 2012 3:07:07 PM</b>
	 * Description   : Functional Test Script
	...
	public void testMain(Object[] args) 
	{
		...
		.startParameter(WN.filePath(Cfg.projectName2, "synccrudwf"))
...
//		"tplan.Workflow.iconcommon.BB.Mgrt_icons.Script"
		...
		vpManual("db",0,getDB("select * from Department where dept_id=3")).performTest();		
	...
	private CustomJsTestScript customTestScript() {
		...
		s.screen("Department_delete").setData("Department_delete_dept_id_paramKey", "3");
