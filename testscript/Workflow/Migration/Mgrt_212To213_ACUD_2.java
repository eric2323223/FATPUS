...
import resources.testscript.Workflow.Migration.Mgrt_212To213_ACUD_2Helper;
 ...
 * @author jiaozhou
 */
public class Mgrt_212To213_ACUD_2 extends Mgrt_212To213_ACUD_2Helper
{
	/**
	 * Script Name   : <b>Mgrt_212To213_ACUD_2</b>
	 * Generated     : <b>May 24, 2012 5:24:34 PM</b>
	 * Description   : Functional Test Script
	...
	public void testMain(Object[] args) 
	{
		...
		WorkFlowEditor.open("pro212", "asynccrudwf1");
		WFCustomizer.runTest(new WorkFlowPackage()
		.startParameter(WN.filePath(Cfg.projectName4, "asynccrudwf1"))
...
//		"tplan.Workflow.iconcommon.BB.Mgrt_icons_srv.Script",
	...
	private CallBackMethod sendNotification() {
		return new CallBackMethod().receiver(WorkFlowEditor.class)
			...
			.parameter(new Email().to("dt").subject("crudid212 = 100"));
	}
