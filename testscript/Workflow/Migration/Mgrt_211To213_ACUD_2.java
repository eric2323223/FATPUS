...
import resources.testscript.Workflow.Migration.Mgrt_211To213_ACUD_2Helper;
 ...
 * @author jiaozhou
 */
public class Mgrt_211To213_ACUD_2 extends Mgrt_211To213_ACUD_2Helper
{
	/**
	 * Script Name   : <b>Mgrt_211To213_ACUD_2</b>
	 * Generated     : <b>May 24, 2012 1:45:24 PM</b>
	 * Description   : Functional Test Script
	...
	public void testMain(Object[] args) 
	{
		...
		WorkFlowEditor.open("projectfor211", "asynccrudwf1");
		WFCustomizer.runTest(new WorkFlowPackage()
		.startParameter(WN.filePath(Cfg.projectName3, "asynccrudwf1"))
...
//		"tplan.Workflow.iconcommon.BB.Mgrt_icons_srv.Script",
	...
	private CallBackMethod sendNotification() {
		return new CallBackMethod().receiver(WorkFlowEditor.class)
			...
			.parameter(new Email().to("dt").subject("crudid211 = 100"));
	}
