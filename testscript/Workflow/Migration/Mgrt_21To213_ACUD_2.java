...
import resources.testscript.Workflow.Migration.Mgrt_21To213_ACUD_2Helper;
 ...
 * @author jiaozhou
 */
public class Mgrt_21To213_ACUD_2 extends Mgrt_21To213_ACUD_2Helper
{
	/**
	 * Script Name   : <b>Mgrt_21To213_ACUD_2</b>
	 * Generated     : <b>May 10, 2012 4:02:25 PM</b>
	 * Description   : Functional Test Script
	...
	public void testMain(Object[] args) 
	{
		...
		WorkFlowEditor.open("projectfor21", "asynccrudwf1");
		WFCustomizer.runTest(new WorkFlowPackage()
		.startParameter(WN.filePath(Cfg.projectName2, "asynccrudwf1"))
...
//		"tplan.Workflow.iconcommon.BB.Mgrt_icons_srv.Script",
	...
	private CallBackMethod sendNotification() {
		return new CallBackMethod().receiver(WorkFlowEditor.class)
			...
			.parameter(new Email().to("dt").subject("crudid21 = 100"));
	}
