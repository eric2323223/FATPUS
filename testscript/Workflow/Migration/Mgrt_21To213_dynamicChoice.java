...
import resources.testscript.Workflow.Migration.Mgrt_21To213_dynamicChoiceHelper;
 ...
 * @author jiaozhou
 */
public class Mgrt_21To213_dynamicChoice extends Mgrt_21To213_dynamicChoiceHelper
{
	/**
	 * Script Name   : <b>Mgrt_21To213_dynamicChoice</b>
	 * Generated     : <b>May 11, 2012 10:17:21 AM</b>
	 * Description   : Functional Test Script
	...
	public void testMain(Object[] args) 
	{
		...
		.startParameter(WN.filePath(Cfg.projectName2, "dynamicchoice"))
...
//		"tplan.Workflow.iconcommon.BB.Mgrt_icons.Script"
		...
		sleep(8);
		vpManual("db",1,getDB("select * from Department where dept_id=4 and dept_name='R & D' and dept_head_id=4")).performTest();
		try {
			DBUtil.runSQL((IDBResource) RC.getResource(ASA.class), "delete from Department where dept_id =4");
	...
	private CustomJsTestScript customTestScript() {
		...
		s.screen("Start_Screen").moveTo("Department_create").throughMenuItem("findall");
		...
		s.screen("Department_create").setData("Department_create_dept_name_paramKey", "Marketing");
