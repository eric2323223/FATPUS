...
import resources.testscript.Workflow.Migration.Mgrt_21To213_CUD_2Helper;
 ...
 * @author jiaozhou
 */
public class Mgrt_21To213_CUD_2 extends Mgrt_21To213_CUD_2Helper
{
	/**
	 * Script Name   : <b>Mgrt_21To213_CUD_2</b>
	 * Generated     : <b>May 10, 2012 2:39:58 PM</b>
	 * Description   : Functional Test Script
	...
	public void testMain(Object[] args) 
	{
		...
		WorkFlowEditor.open("projectfor21", "synccrudwf1");
		WFCustomizer.runTest(new WorkFlowPackage()
		.startParameter(WN.filePath(Cfg.projectName2, "synccrudwf1"))
...
//		"tplan.Workflow.iconcommon.BB.Mgrt_icons.Script",
	...
	private CallBackMethod sendNotification() {
		return new CallBackMethod().receiver(WorkFlowEditor.class)
			...
			.parameter(new Email().to("dt").subject("findall21"));
	}
