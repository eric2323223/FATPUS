...
import resources.testscript.Workflow.Migration.Mgrt_21To213_CtrlHelper;
 ...
 * @author jiaozhou
 */
public class Mgrt_21To213_Ctrl extends Mgrt_21To213_CtrlHelper
{
	/**
	 * Script Name   : <b>Mgrt_21To213_Ctrl</b>
	 * Generated     : <b>May 10, 2012 4:50:18 PM</b>
	 * Description   : Functional Test Script
	...
	public void testMain(Object[] args) 
	{
		...
		WorkFlowEditor.open("projectfor21", "controlwf");
		WFCustomizer.runTest(new WorkFlowPackage()
		.startParameter(WN.filePath(Cfg.projectName2, "controlwf"))
...
//		"tplan.Workflow.iconcommon.BB.Mgrt_icons_srv.Script",
	...
	private CallBackMethod sendNotification() {
		return new CallBackMethod().receiver(WorkFlowEditor.class)
			...
			.parameter(new Email().to("dt").subject("ctrl21"));
	}
