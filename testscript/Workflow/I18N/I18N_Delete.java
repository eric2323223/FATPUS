...
import resources.testscript.Workflow.I18N.I18N_DeleteHelper;
 ...
 * @author flvxp
 */
public class I18N_Delete extends I18N_DeleteHelper
{
	/**
	 * Script Name   : <b>I18N_Delete</b>
	 * Generated     : <b>Nov 29, 2011 6:01:27 AM</b>
	 * Description   : Functional Test Script
	...
	public void testMain(Object[] args) 
	{
		...
		WorkFlowEditor.addMenuItem("Start Screen", new WFScreenMenuItem()
				...
				.defaultSuccessScreen("I18N_delete_instance"));
		WorkFlowEditor.setMenuItem("I18N_delete_instance", new WFScreenMenuItem()
				.name("Delete")
	...
	private CustomJsTestScript customTestScript() {
		...
		s.screen("Start_Screen").moveTo("I18N_delete_instance").throughMenuItem("findByPrimaryKey");
		s.screen("I18N_delete_instance").moveTo("Start_Screen").throughMenuItem("Delete");
		//verify
		s.screen("Start_Screen").moveTo("I18N").throughMenuItem("findAll");
		s.screen("I18N").checkListItem("姓名", "0");
		//
		return s;
	}
}