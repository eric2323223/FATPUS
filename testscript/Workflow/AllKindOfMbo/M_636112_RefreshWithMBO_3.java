...
import resources.testscript.Workflow.AllKindOfMbo.M_636112_RefreshWithMBO_3Helper;
 ...
 * @author ffan
 */
public class M_636112_RefreshWithMBO_3 extends M_636112_RefreshWithMBO_3Helper
{
	/**
	 * Script Name   : <b>M_636112_RefreshWithMBO_3</b>
	 * Generated     : <b>Nov 25, 2011 11:38:44 PM</b>
	 * Description   : Functional Test Script
	...
	public void testMain(Object[] args) 
	{
		...
		mbo.renameAttribute("dept_name","mydept_name");
		MainMenu.saveAll();
		
		WN.openWorkFlow(Cfg.projectName, "myWF_3.xbw");
		WorkFlowEditor.dragMbo(Cfg.projectName, "Department");
		WorkFlowEditor.link(WorkFlow.SP_SERVER_INIT,"Department");
		...
		vpManual("haseditbox",true,WorkFlowEditor.hasWidgetInScreen("Departmentcreate", new WFEditBox().label("Mydept name:"))).performTest();
