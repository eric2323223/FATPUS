...
import resources.testscript.Workflow.Screens.CS_EmailSub_One2One_Cascade_Parent_MOHelper;
 ...
 * @author eric
 */
public class CS_EmailSub_One2One_Cascade_Parent_MO extends CS_EmailSub_One2One_Cascade_Parent_MOHelper
{
	/**
	 * Script Name   : <b>CS_EmailSub_One2One_Cascade_Parent_MO</b>
	 * Generated     : <b>Sep 15, 2011 4:17:56 PM</b>
	 * Description   : Functional Test Script
...
//				GlobalConfig.getRFTProjectRoot()+"/testscript/Workflow/Screens/setup/add_a_b.sql");
		...
		vpManual("link", true, WorkFlowEditor.hasLinkBetween("Server-initiated (Wf_ff_a)","Wfffa")).performTest();
		vpManual("link", true, WorkFlowEditor.hasLinkBetween("Wfffa","WfffaDetail")).performTest();
