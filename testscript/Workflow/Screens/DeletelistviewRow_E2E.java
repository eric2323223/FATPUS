...
import resources.testscript.Workflow.Screens.DeletelistviewRow_E2EHelper;
 ...
 * @author eric
 */
public class DeletelistviewRow_E2E extends DeletelistviewRow_E2EHelper
{
	/**
	 * Script Name   : <b>DeletelistviewRow_E2E_Android</b>
	 * Generated     : <b>Sep 19, 2011 10:03:35 AM</b>
	 * Description   : Functional Test Script
...
//			"tplan.Workflow.iconcommon.BB.server_dt_icon.Script",
		...
		WFCustomizer.verifyResult(new WFClientResult().data(
				...
				"id=Wf_ff_b_bname_attribKey,value=BNewthree"));
		sleep(1);
