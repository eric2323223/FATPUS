...
import resources.testscript.Workflow.Screens.CSFO_One2Many_Cascade_ChildHelper;
 ...
 * @author eric
 */
public class CSFO_One2Many_Cascade_Child extends CSFO_One2Many_Cascade_ChildHelper
{
	/**
	 * Script Name   : <b>CSFO_One2Many_Cascade_Child</b>
	 * Generated     : <b>Sep 8, 2011 2:29:21 AM</b>
	 * Description   : Functional Test Script
	...
	public void testMain(Object[] args) 
	{
		...
		vpManual("creen", false, WorkFlowEditor.hasScreen("DepartmentDetail")).performTest();
		vpManual("creen", false, WorkFlowEditor.hasScreen("Departmentcreate")).performTest();
		vpManual("creen", false, WorkFlowEditor.hasScreen("Departmentdeleteinstance")).performTest();
		vpManual("creen", false, WorkFlowEditor.hasScreen("Departmentupdateinstance")).performTest();
