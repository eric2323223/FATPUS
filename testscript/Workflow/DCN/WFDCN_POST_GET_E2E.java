...
import resources.testscript.Workflow.DCN.WFDCN_POST_GET_E2EHelper;
 ...
 * @author ffan
 */
public class WFDCN_POST_GET_E2E extends WFDCN_POST_GET_E2EHelper
{
	/**
	 * Script Name   : <b>WFDCN_POST_GET_E2E</b>
	 * Generated     : <b>Nov 18, 2011 3:49:34 PM</b>
	 * Description   : Functional Test Script
	...
	//vp1: set GET:
		DCNRequestSender.get(insertUrl());
		vpManual("cdb", 1, CDBUtil.getRecordCount("ffan_xp32en_2", Cfg.projectName, "Department", new QueryCriteria().clause("dept_name='myname1'"))).performTest();
