...
import resources.testscript.Workflow.DCN.WFDCN_PartialValidRecipients_E2E_ffHelper;
 ...
 * @author ffan
 */
public class WFDCN_PartialValidRecipients_E2E_ff extends WFDCN_PartialValidRecipients_E2E_ffHelper
{
	/**
	 * Script Name   : <b>WFDCN_PartialValidRecipients_E2E_ff</b>
	 * Generated     : <b>Nov 24, 2011 3:51:41 AM</b>
	 * Description   : Functional Test Script
...
//			.unwiredServer("My Unwired Server"));
		...
		//vp: set a Valid and invalid recipient:
			DCNRequestSender.post(insertUrlTo());
		//"supAdmin" will pass,but "wronguser" has not changed:
			vpManual("cdb", 1, CDBUtil.getRecordCount("ffan_xp32en_2", Cfg.projectName, "Department", new QueryCriteria().clause("dept_id=1200"))).performTest();
		}
	...
	//include correct to"supAdmin" and  wrong to"wronguser"
	private URL insertUrlTo(){
		try{
			String wfdcn_request = "{\"id\":\"dcntest_99\",\"op\":\":upsert\",\"subject\":\"dept_id = 1200\",\"to\":\"supAdmin,wronguser\",\"from\":\"yongli\",\"read\":false,\"priority\":true,\"body\":\"WF%20DCN%20Test%20Body\",\"data\":[{\"id\":\"dcntest_1_data_1\",\"pkg\":\"working:1.0\",\"messages\":[{\"id\":\"1\",\"mbo\":\"Department\",\"op\":\":upsert\",\"cols\":{\"dept_id\":\"1200\",\"dept_name\":\"x\",\"dept_head_id\":\"501\"},\"parameters\":{}}]}]}";
