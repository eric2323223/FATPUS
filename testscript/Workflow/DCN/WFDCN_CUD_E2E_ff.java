...
import resources.testscript.Workflow.DCN.WFDCN_CUD_E2E_ffHelper;
 ...
 * @author ffan
 */
public class WFDCN_CUD_E2E_ff extends WFDCN_CUD_E2E_ffHelper
{
	/**
	 * Script Name   : <b>WFDCN_CUD_E2E_ff</b>
	 * Generated     : <b>Nov 22, 2011 3:43:19 PM</b>
	 * Description   : Functional Test Script
...
//			.to("supAdmin")
//			.unwiredServer("My Unwired Server"));
		//get message from supAdmin
////////////////////////////////1.create record:
		DCNRequestSender.post(insertUrl());
		vpManual("cdb", 1, CDBUtil.getRecordCount("10.56.252.222", Cfg.projectName, "Department", new QueryCriteria().clause("dept_name='x'"))).performTest();
		
		//get message from yongli,!
//		insertOrUpdateCheck();
		
//		// after insert :
//		WFCustomizer.verifyResult(new WFClientResult().data("id=Department_dept_name_attribKey,value ='x'"));
//	ok=========================================================================
		
//////////////////////////2.update record:
//		DCNRequestSender.post(updateUrl());
//		vpManual("cdb", 1, CDBUtil.getRecordCount("10.56.252.222", Cfg.projectName, "Department", new QueryCriteria().clause("dept_name='xxx'"))).performTest();
//		// after update :
//		WFCustomizer.verifyResult(new WFClientResult().data("id=Department_dept_name_attribKey,value ='xxx'"));
//
////////////////////3.delete record:  Note:For delete, not return message
//		DCNRequestSender.post(deleteUrl());
//		
////	vpManual("cdb", 0, CDBUtil.getRecordCount("10.56.252.222", Cfg.projectName, "Department", new QueryCriteria().clause("dept_name='x'"))).performTest();
	}
	...
	private URL insertUrl(){
		try{
			String wfdcn_request = "{\"id\":\"dcntest_911\",\"op\":\":upsert\",\"subject\":\"dept_id = 700\",\"to\":\"supAdmin\",\"from\":\"yongli\",\"read\":false,\"priority\":true,\"body\":\"WF%20DCN%20Test%20Body\",\"data\":[{\"id\":\"dcntest_1_data_1\",\"pkg\":\"working:1.0\",\"messages\":[{\"id\":\"1\",\"mbo\":\"Department\",\"op\":\":upsert\",\"cols\":{\"dept_id\":\"700\",\"dept_name\":\"x\",\"dept_head_id\":\"501\"},\"parameters\":{}}]}]}";
	...
	private URL updateUrl(){
		try {
			String wfdcn_request = "{\"id\":\"dcntest_92\",\"op\":\":upsert\",\"subject\":\"dept_id = 700\",\"to\":\"supAdmin\",\"from\":\"yongli\",\"read\":false,\"priority\":true,\"body\":\"WF%20DCN%20Test%20Body\",\"data\":[{\"id\":\"dcntest_1_data_1\",\"pkg\":\"wf:1.0\",\"messages\":[{\"id\":\"1\",\"mbo\":\"Department\",\"op\":\":upsert\",\"cols\":{\"dept_id\":\"700\",\"dept_name\":\"xxx\",\"dept_head_id\":\"501\"},\"parameters\":{}}]}]}";
			return new URL("HTTP", "10.56.252.222", 8000,
							"/dcn/DCNServlet?cmd=wf&security=admin&domain=default&username=supAdmin&password=s3pAdmin&dcn_request=" + URLEncoder.encode(wfdcn_request));
		} catch (MalformedURLException e) {
			e.printStackTrace();
	...
	private URL deleteUrl(){
		try {
			String wfdcn_request = "{\"id\":\"dcntest_93\",\"op\":\":delete\",\"subject\":\"dept_id = 700\",\"to\":\"supAdmin\",\"from\":\"yongli\",\"read\":false,\"priority\":true,\"body\":\"WF%20DCN%20Test%20Body\",\"data\":[{\"id\":\"dcntest_1_data_1\",\"pkg\":\"wf:1.0\",\"messages\":[{\"id\":\"1\",\"mbo\":\"Department\",\"op\":\":delete\",\"cols\":{\"dept_id\":\"700\"},\"parameters\":{}}]}]}";
					return new URL("HTTP", "10.56.252.222", 8000,
									"/dcn/DCNServlet?cmd=wf&security=admin&domain=default&username=supAdmin&password=s3pAdmin&dcn_request=" + URLEncoder.encode(wfdcn_request));
		} catch (MalformedURLException e) {
			e.printStackTrace();
