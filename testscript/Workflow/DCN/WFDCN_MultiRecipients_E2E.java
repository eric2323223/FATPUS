...
import resources.testscript.Workflow.DCN.WFDCN_MultiRecipients_E2EHelper;
 ...
 * @author ffan
 */
public class WFDCN_MultiRecipients_E2E extends WFDCN_MultiRecipients_E2EHelper
{
	/**
	 * Script Name   : <b>WFDCN_MultiRecipients_E2E</b>
	 * Generated     : <b>Nov 18, 2011 2:35:42 PM</b>
	 * Description   : Functional Test Script
	...
	//vp1:have set recipient:
		DCNRequestSender.post(insertUrlHaveTo());
		//vp:backend
	...
	//not have set to(recipient)
	private URL insertUrlNotHaveTo(){
		try{
			String wfdcn_request = "{\"id\":\"1\",\"op\":\":upsert\",\"subject\":\"updated\",\"to\":\"\",\"from\":\"ff\",\"read\":false,\"priority\":true,\"body\":\"WF%20DCN%20Test%20Body\",\"data\":[{\"id\":\"1\",\"pkg\":\"wf:1.0\",\"messages\":[{\"id\":\"1\",\"mbo\":\"Department\",\"op\":\":upsert\",\"cols\":{\"dept_id\":\"10\",\"dept_name\":\"myname2\",\"dept_head_id\":\"501\"},\"parameters\":{}}]}]}";
...
//	private CallBackMethod insertDCNHaveTo() {
//		return new CallBackMethod().receiver(DCNRequestSender.class)
//			.methodName("post")
//			.parameter(insertDCNHaveTo())	;
//	}
//	
//	private CallBackMethod insertDCNNotHaveTo() {
//		return new CallBackMethod().receiver(DCNRequestSender.class)
//		.methodName("post")
//		.parameter(insertDCNNotHaveTo())	;
//	}
