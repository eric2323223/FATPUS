...
import resources.testscript.Workflow.DCN.WFDCN_NoDataReq_E2E_ffHelper;
 ...
 * @author ffan
 */
public class WFDCN_NoDataReq_E2E_ff extends WFDCN_NoDataReq_E2E_ffHelper
{
	/**
	 * Script Name   : <b>WFDCN_NoDataReq_E2E_ff</b>
	 * Generated     : <b>Nov 24, 2011 3:32:49 AM</b>
	 * Description   : Functional Test Script
...
//			.unwiredServer("My Unwired Server"));
		...
		//vp: no data request:
		DCNRequestSender.post(insertUrlNoDataRequest());
	...
	private URL insertUrlNoDataRequest(){
		try{
			String wfdcn_request = "{\"id\":\"dcntest_102\",\"op\":\":upsert\",\"subject\":\"dept_id = 1300\",\"to\":\"supAdmin\",\"from\":\"yongli\",\"read\":false,\"priority\":true,\"body\":\"WF%20DCN%20Test%20Body\"}";
