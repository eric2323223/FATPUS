...
import resources.testscript.Workflow.DCN.WFDCN_HttpAuth_E2EHelper;
 ...
 * @author ffan
 */
public class WFDCN_HttpAuth_E2E extends WFDCN_HttpAuth_E2EHelper
{
	/**
	 * Script Name   : <b>WFDCN_HttpAuth_E2E</b>
	 * Generated     : <b>Nov 18, 2011 5:26:10 PM</b>
	 * Description   : Functional Test Script
	...
	//VP:Use http auth model:
	private URL insertUrl(){
		try{
			String wfdcn_request = "{\"id\":\"1\",\"op\":\":upsert\",\"subject\":\"updated\",\"to\":\"supAdmin\",\"from\":\"ff\",\"read\":false,\"priority\":true,\"body\":\"WF%20DCN%20Test%20Body\",\"data\":[{\"id\":\"1\",\"pkg\":\"wf:1.0\",\"messages\":[{\"id\":\"1\",\"mbo\":\"Department\",\"op\":\":upsert\",\"cols\":{\"dept_id\":\"102\",\"dept_name\":\"myname102\",\"dept_head_id\":\"501\"},\"parameters\":{}}]}]}";
...
//		not be used now :
		...
		private CustomJsTestScript insertCheck() {
			...
			s.screen("Department").checkListItem("102", "0");
			return s;
		}
