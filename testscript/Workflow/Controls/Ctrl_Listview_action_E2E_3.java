...
import resources.testscript.Workflow.Controls.Ctrl_Listview_action_E2E_3Helper;
 ...
 * @author ffan
 */
public class Ctrl_Listview_action_E2E_3 extends Ctrl_Listview_action_E2E_3Helper
{
	/**
	 * Script Name   : <b>Ctrl_Listview_action_E2E_3</b>
	 * Generated     : <b>Dec 26, 2011 10:13:36 AM</b>
	 * Description   : Functional Test Script
...
//			GlobalConfig.getRFTProjectRoot()+"/testscript/Workflow/Controls/setup/createff_wf_ab.sql");
		...
		////1.used to Android:
		TestResult result = Robot.run("tplan.Workflow.Controls.android.Ctrl_Listview_action_add.Script");
		vpManual("DeviceTest", true, result.isPass()).performTest();
		
		////2.used to BB6T:
		TestResult resultBB= Robot.run("tplan.Workflow.Controls.BB.Ctrl_Listview_action_add.Script");
		vpManual("DeviceTest", true, resultBB.isPass()).performTest();
		
		//vp_add: verify the new record "aid=3,bid=22" has added in backend db in ff_wf_a   Note:OK>>>
