...
import resources.testscript.Workflow.Controls.Ctrl_Listview_E2E_2Helper;
 ...
 * @author ffan
 */
public class Ctrl_Listview_E2E_2 extends Ctrl_Listview_E2E_2Helper
{
	/**
	 * Script Name   : <b>Ctrl_Listview_E2E_2</b>
	 * Generated     : <b>Dec 22, 2011 5:07:00 PM</b>
	 * Description   : Functional Test Script
	...
	public void testMain(Object[] args) 
	{
		...
		//excute:delete from onerecord where id=1; //delete from onerecord where id=2;
		WN.useProject(Cfg.projectName);
	
		EE.runSQL(new ScrapbookCP().database("sampledb")
				.type("Sybase_ASA_12.x").name("My Sample Database"), 
				GlobalConfig.getRFTProjectRoot()+"/testscript/Workflow/Controls/setup/deleteAll_onerecord.sql");
		...
		////1.used to Android:
//		TestResult result = Robot.run("tplan.Workflow.Controls.android.Ctrl_Listview_2.Script");
//		vpManual("DeviceTest", true, result.isPass()).performTest();
		
		////2.used to BB:passed
		TestResult resultBB = Robot.run("tplan.Workflow.Controls.BB.Ctrl_Listview_2.Script");
