...
import resources.testscript.Workflow.Controls.Locale_specific_Language_E2EHelper;
 ...
 * @author ffan
 */
public class Locale_specific_Language_E2E extends Locale_specific_Language_E2EHelper
{
	/**
	 * Script Name   : <b>Locale_specific_Language_E2E</b>
	 * Generated     : <b>Nov 1, 2011 2:15:19 AM</b>
	 * Description   : Functional Test Script
...
//*************the language in device need to set french :
...
////1.used to Android:
//		TestResult result = Robot.run("tplan.Workflow.Controls.android.Locale_specific_Language.Script");
//		vpManual("DeviceTest", true, result.isPass()).performTest();
		
////2.used to BB6T: passed
		TestResult resultBB = Robot.run("tplan.Workflow.Controls.BB.Locale_specific_Language.Script");
