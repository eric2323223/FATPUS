...
import resources.testscript.Workflow.Controls.Ctrl_Listview_action_E2E_1Helper;
 ...
 * @author ffan
 */
public class Ctrl_Listview_action_E2E_1 extends Ctrl_Listview_action_E2E_1Helper
{
	/**
	 * Script Name   : <b>Ctrl_Listview_action_E2E</b>
	 * Generated     : <b>Dec 21, 2011 9:40:01 AM</b>
	 * Description   : Functional Test Script
...
////////////////////    VP: finished show record and delete operation    /////////////////////
...
//			GlobalConfig.getRFTProjectRoot()+"/testscript/Workflow/Controls/setup/createff_wf_ab.sql");
		...
		////1.used to Android:
		TestResult result = Robot.run("tplan.Workflow.Controls.android.Ctrl_Listview_action_delete.Script");
		vpManual("DeviceTest", true, result.isPass()).performTest();
		
		////2.used to BB:passed
		TestResult resultBB = Robot.run("tplan.Workflow.Controls.BB.Ctrl_Listview_action_delete.Script");
		vpManual("DeviceTest", true, resultBB.isPass()).performTest();
		
		//vp_delete: verify the  record "aid=2,bid=22" has deleted in backend db in ff_wf_a   Note:OK>>>
		java.util.List<String> clause = new ArrayList<String>();
		clause.add("aid=2");
		clause.add("bid=22");
		vpManual("dbresult", true, 0 == CDBUtil.getRecordCount("ffan_xp32en_2", "wf", "Ff_wf_a", clause)).performTest();
	}
