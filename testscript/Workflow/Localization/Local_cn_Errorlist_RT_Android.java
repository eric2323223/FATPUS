...
import resources.testscript.Workflow.Localization.Local_cn_Errorlist_RT_AndroidHelper;
 ...
 * @author flvxp
 */
public class Local_cn_Errorlist_RT_Android extends Local_cn_Errorlist_RT_AndroidHelper
{
	/**
	 * Script Name   : <b>Local_cn_Errorlist_RT_Android</b>
	 * Generated     : <b>Nov 24, 2011 11:03:40 PM</b>
	 * Description   : Functional Test Script
	...
	public void testMain(Object[] args) 
	{
		...
		WFLocalizationTab.WFChangeLocalFileContent(Cfg.projectName, "myWF_zh_CN.properties", "SCREEN7NAME=ErrorList", "SCREEN7NAME=错误列表");
		WFLocalizationTab.WFEdit(Cfg.projectName, "myWF.xbw", "Chinese (China)");
		WFLocalizationTab.WFChangeLocalFileContent(Cfg.projectName, "myWF_zh_CN.properties", "SCREEN8NAME=ErrorDetail", "SCREEN8NAME=错误详细信息");
		MainMenu.saveAll();
		//
		...
		WFCustomizer.verifyResult(new WFClientResult().data(
				"list_items_count=1|value=错误列表|value=错误详细信息"));
	}
