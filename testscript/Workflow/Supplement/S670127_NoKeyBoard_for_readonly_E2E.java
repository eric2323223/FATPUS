...
import resources.testscript.Workflow.Supplement.S670127_NoKeyBoard_for_readonly_E2EHelper;
 ...
 * @author ffan
 */
public class S670127_NoKeyBoard_for_readonly_E2E extends S670127_NoKeyBoard_for_readonly_E2EHelper
{
	/**
	 * Script Name   : <b>S670127_NoKeyBoard_for_readonly_BB_E2E</b>
	 * Generated     : <b>Mar 15, 2012 3:15:02 AM</b>
	 * Description   : Functional Test Script
	...
	public void testMain(Object[] args) 
	{
		...
		PropertiesView.resetWidget("AllDTupdateinstance", new WFEditBox().label("String1:").ifReadonly(true));
		MainMenu.saveAll();
	...
	//////1.used to Android:passed
			TestResult resultAndroid = Robot.run("tplan.Workflow.Supplement.Android.S670127_NoKeyBoard_for_readonly_Android.Script");
