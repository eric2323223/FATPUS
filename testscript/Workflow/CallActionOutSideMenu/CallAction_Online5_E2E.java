...
import resources.testscript.Workflow.CallActionOutSideMenu.CallAction_Online5_E2EHelper;
 ...
 * @author flvxp
 */
public class CallAction_Online5_E2E extends CallAction_Online5_E2EHelper {
	/**
	 * Script Name : <b>CallAction_Online5_E2E</b> Generated : <b>Mar 29, 2012
	 * 2:15:40 AM</b> Description : Functional Test Script Original Host : WinNT
	...
	public void testMain(Object[] args) {
		...
		mbo.setOperation(new Operation().startParameter(
				...
				new OperationParameter().pk("pk1").name("b").toString()));
