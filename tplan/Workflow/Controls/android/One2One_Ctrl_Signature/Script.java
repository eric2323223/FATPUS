package tplan.Workflow.Controls.android.One2One_Ctrl_Signature;
import resources.tplan.Workflow.Controls.android.One2One_Ctrl_Signature.ScriptHelper;
...
//		startWorkflowApplication("sybase");
		...
		clickOn("wf_item_dept=1");
//		waitForDispear("inprogress_toast_android");
		waitForMatch("show_signature_emp_sign",10);
	}
}
