package tplan.Workflow.Supplement.Android.S670609_Keyboard_hide_Android;
...
public class Script extends AndroidTestScript{
	...
	public void doTest() throws Exception {
		...
		clickOn("label");
		clickOnWithOffSet("direction",-29,72); //Menu_Android
		waitForMatch("OpenAllDTcreate",10);
		clickOn("OpenAllDTcreate");
		clickOn("String1");
		waitForMatch("keyboard",10);
		
		clickOnWithOffSet("direction",-29,72);
		waitForMatch("OpenStart",10);
		clickOn("OpenStart");
		waitForMatch("label",10);
		clickOn("label");
		
		clickOnWithOffSet("direction",28,72); //Back_Android
	}
	
//	public static void main(String [] args){
//		Robot.run("tplan.Workflow.Supplement.Android.S670609_Keyboard_hide_Android.Script");
//	}
}
