package tplan.Workflow.Supplement.Android.S658435_No_Dup_InstalledWF_Android;
...
public class Script extends AndroidTestScript{
	...
	public void doTest() throws Exception {
		...
		waitForMatch("myWF1_A",10);
//		clickOn("myWF2_A");
		
	}
	public static void main(String [] args){
		Robot.run("tplan.Workflow.Supplement.Android.S658435_No_Dup_InstalledWF_Android.Script");
	}
}
