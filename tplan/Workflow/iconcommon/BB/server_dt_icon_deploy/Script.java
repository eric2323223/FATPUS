package tplan.Workflow.iconcommon.BB.server_dt_icon_deploy;
import resources.tplan.Workflow.iconcommon.BB.server_dt_icon_deploy.ScriptHelper;
...
//		openMessageEntry("server_dt");
		waitForMatch("server_dt*",10);
	}
}
