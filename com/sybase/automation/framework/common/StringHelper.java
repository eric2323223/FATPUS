...
public final class StringHelper 
{
    ...
    public static String join(String seperator, String[] strings) 
    {
        ...
        return "";
        StringBuffer buf =
            new StringBuffer(length * strings[0].length()).append(strings[0]);
        ...
        boolean wholeWords) 
    {
        ...
        else 
        {
            final boolean actuallyReplace =
                ...
                template.charAt(loc + placeholder.length()));
            String actualReplacement =
                actuallyReplace ? replacement : placeholder;
    ...
    public static String unroot(String qualifiedName) 
    {
        ...
        return (loc < 0)
            ? qualifiedName
            : qualifiedName.substring(loc + 1, qualifiedName.length());
    }
    ...
    public static int firstIndexOfChar(
        String sqlString,
        String string,
        int startindex) 
    {
    ...
    private static String generateAliasRoot(String description) 
    {
        final String result =
            truncate(
            unqualifyEntityName(description),
            ALIAS_TRUNCATE_LENGTH)
            .toLowerCase()
            .replace(
            '/',
            '_') // entityNames may now include slashes for the representations
